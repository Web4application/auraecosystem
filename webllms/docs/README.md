***
LMLM Studio 0.4.1 [#lmlm-studio-041]
...
LM Studio 0.3.24 • 2025‑08‑28 [#lm-studio-0324-20250828]
...
* Tool names are normalized (e.g., snake\_case) before being provided to the model to improve tool‑calling reliability [‡](/blog/lmstudio-v0.3.23).
...
LM Studio 0.3.19 • 2025‑07‑21 [#lm-studio-0319-20250721]
...
LM Studio 0.3.17 • 2025‑06‑25 [#lm-studio-0317-20250625]
...
👾 LM Studio 0.3.14 • 2025-03-27 [#-lm-studio-0314--2025-03-27]
...
👾 LM Studio 0.3.10 • 2025-02-18 [#-lm-studio-0310--2025-02-18]
...
👾 LM Studio 0.3.9 • 2025-01-30 [#-lm-studio-039--2025-01-30]
...
👾 LM Studio 0.3.6 • 2025-01-06 [#-lm-studio-036--2025-01-06]
...
👾 LM Studio 0.3.5 • 2024-10-22 [#-lm-studio-035--2024-10-22]
...
Get to know the stack [#get-to-know-the-stack]
...
<Cards>
  ...
  <Card title="Tool calling and local agents with MCP" description="Connect tools, MCP servers, and agent-like workflows entirely on your machine." href="/docs/developer/openai-compat/tools" icon="<Blocks className=&#x22;text-fuchsia-400&#x22; />" />
...
lms get <lmlmmodel>        # Download a model
...
Quick Example: Chat with a Llama Model [#quick-example-chat-with-a-llama-model]
...
The `lms` CLI is open source on GitHub: [https://github.com/lmstudio-ai/lms](https://github.com/lmstudio-ai/lms)
...
<Callout type="success" title="Pro Tip">
  Have a powerful LLM rig? Use [LM Link](/docs/integrations/lmlink) to run Hermes Agent from your laptop while the model runs on your rig.
</Callout>
...
<img src="/assets/marketing/docs/lmlink-animation.gif" style="width: 75%;" data-caption="Introducing LM Link" />
...
Providing the API Token [#providing-the-api-token]
...
<CodeBlockTabs defaultValue="Environment Variable">
  <CodeBlockTabsList>
    <CodeBlockTabsTrigger value="Environment Variable">
      Environment Variable
    </CodeBlockTabsTrigger>

    <CodeBlockTabsTrigger value="Function Argument">
      Function Argument
    </CodeBlockTabsTrigger>
  </CodeBlockTabsList>

  <CodeBlockTab value="Environment Variable">
    ```typescript
  ...
  <CodeBlockTab value="Function Argument">
    ```typescript
    import { LMStudioClient } from "@lmstudio/sdk";
    const client = new LMStudioClient({
...
Creating a New `node` Project [#creating-a-new-node-project]

Use the following command to start an interactive project setup:

<CodeBlockTabs defaultValue="TypeScript (Recommended)">
  <CodeBlockTabsList>
    <CodeBlockTabsTrigger value="TypeScript (Recommended)">
  ...
  <CodeBlockTab value="TypeScript (Recommended)">
    ```bash
...
Add `lmstudio-js` to an Exiting Project [#add-lmstudio-js-to-an-exiting-project]
...
Where are chats stored in the file system? [#where-are-chats-stored-in-the-file-system]
...
Does the model learn from chats? [#does-the-model-learn-from-chats]
...
Conversations folder filesystem path [#conversations-folder-filesystem-path]
...
LM Studio app, llmster, and lms [#lm-studio-app-llmster-and-lms]
...
llmster (the headless daemon) [#llmster-the-headless-daemon]
...
Once the server is running, it listens on [http://localhost:1234](http://localhost:1234). Point any SDK or compatible tool at our OpenAI or Anthropic-compatible endpoints to use your LM Studio models.
...
\* In this context, 'Generation' means the output of the LLM. [#-in-this-context-generation-means-the-output-of-the-llm]

Context sizes are measured in "tokens". One token is often about 3/4 of a word. [#context-sizes-are-measured-in-tokens-one-token-is-often-about-34-of-a-word]

RAG vs. Full document 'in context' [#rag-vs-full-document-in-context]
...
Tip for successful RAG [#tip-for-successful-rag]
...
<DocsParamsTable data="-%20name%3A%20%22lmstudio%3A%2F%2F%22%0A%20%20type%3A%20%22protocol%22%0A%20%20description%3A%20%22The%20protocol%20scheme%20to%20open%20LM%20Studio%22%0A-%20name%3A%20%22add_mcp%22%0A%20%20type%3A%20%22path%22%0A%20%20description%3A%20%22The%20action%20to%20install%20an%20MCP%20server%22%0A-%20name%3A%20%22name%22%0A%20%20type%3A%20%22query%20parameter%22%0A%20%20description%3A%20%22The%20name%20of%20the%20MCP%20server%20to%20install%22%0A-%20name%3A%20%22config%22%0A%20%20type%3A%20%22query%20parameter%22%0A%20%20description%3A%20%22Base64%20encoded%20JSON%20configuration%20for%20the%20MCP%20server%22" />
...
Install new servers: `mcp.json` [#install-new-servers-mcpjson]

Switch to the "Program" tab in the right hand sidebar. Click `Install > Edit mcp.json`.

<img src="/assets/marketing/docs/install-mcp.png" style="{ width: &#x22;80%&#x22; }" />

This will open the `mcp.json` file in the in-app editor. You can add MCP servers by editing this file.

<img src="/assets/marketing/docs/mcp-editor.png" data-caption="Edit mcp.json using the in-app editor" style="{ width: &#x22;100%&#x22; }" />
...
<div className="w-fit">
  <a style="{ background: &#x22;rgb(255,255,255)&#x22; }" href="https://lmstudio.ai/install-mcp?name=hf-mcp-server&config=eyJ1cmwiOiJodHRwczovL2h1Z2dpbmdmYWNlLmNvL21jcCIsImhlYWRlcnMiOnsiQXV0aG9yaXphdGlvbiI6IkJlYXJlciA8WU9VUl9IRl9UT0tFTj4ifX0%3D">
    <img src="https://files.lmstudio.ai/deeplink/mcp-install-light.svg" alt="Add MCP Server hf-mcp-server to LM Studio" className="dark:hidden" />

    <img src="https://files.lmstudio.ai/deeplink/mcp-install-dark.svg" alt="Add MCP Server hf-mcp-server to LM Studio" className="hidden dark:block" />
  </a>
</div>
...
Note: `model.yaml` refers to metadata only. This means it does not include the actual model weights. [#note-modelyaml-refers-to-metadata-only-this-means-it-does-not-include-the-actual-model-weights]
...
Change the publisher to your user [#change-the-publisher-to-your-user]
...
Publish your model [#publish-your-model]
...
Downloading a model and using it in LM Studio [#downloading-a-model-and-using-it-in-lm-studio]
...
<img src="/assets/marketing/docs/preset-import-button.png" data-caption="Import Presets" />
...
<img src="/assets/marketing/docs/import-preset-from-url.png" data-caption="Import Presets by URL" />
...
Saving, resetting, and deselecting Presets [#saving-resetting-and-deselecting-presets]
...
Step 1: Click the Publish Button [#step-1-click-the-publish-button]

Identify the Preset you want to publish in the Preset dropdown. Click the `•••` button and select "Publish" from the menu.

<img src="/assets/marketing/docs/preset-publish-new.png" data-caption="Click the Publish button to publish your Preset to the LM Studio Hub." />
...
<img src="/assets/marketing/docs/preset-publish-details.png" data-caption="Set the details of your Preset before publishing." />
...
How to Pull Updates [#how-to-pull-updates]

Click the `•••` button in the Preset dropdown and select "Pull" from the menu.

<img src="/assets/marketing/docs/preset-pull-latest.png" data-caption="Pull the latest revisions of your or imported Presets." />
...
Selecting a Language [#selecting-a-language]
...
Big thank you to community localizers 🙏 [#big-thank-you-to-community-localizers-]
...
Contributing to LM Studio localization [#contributing-to-lm-studio-localization]

If you want to improve existing translations or contribute new ones, you're more than welcome to jump in.

LM Studio strings are maintained in [https://github.com/lmstudio-ai/localization](https://github.com/lmstudio-ai/localization).
...
<img src="/assets/marketing/docs/enable-developermode.png" style="width:80%; margin-top:30px" data-caption="Enable developer mode in settings" />
...
<img src="/assets/marketing/docs/parallel-requests.png" style="width:80%; margin-top:30px" data-caption="Send parallel requests using split view in chat" />
...
<video style="{ width: &#x22;50%&#x22; }" data-caption="You can set the default parameters for a model in this dialog.">
...
<Callout type="success" title="Pro Tip">
  Reasons to set default load parameters (not required, totally optional) [#reasons-to-set-default-load-parameters-not-required-totally-optional]
...
Pro tip: you can jump to the My Models tab from anywhere by pressing `⌘` + `3` on Mac, or `ctrl` + `3` on Windows / Linux. [#pro-tip-you-can-jump-to-the-my-models-tab-from-anywhere-by-pressing---3-on-mac-or-ctrl--3-on-windows--linux]

Customize the Prompt Template [#customize-the-prompt-template]

💡 In most cases you don't need to change the prompt template [#-in-most-cases-you-dont-need-to-change-the-prompt-template]
...
<img src="/assets/marketing/docs/prompt-template.png" style="width:80%" data-caption="The Prompt Template config box in the chat sidebar">
...
Reasons you might want to edit the prompt template: [#reasons-you-might-want-to-edit-the-prompt-template]
...
How to enable Speculative Decoding [#how-to-enable-speculative-decoding]
...
Key factors affecting performance [#key-factors-affecting-performance]

Speculative decoding speed-up is generally dependent on two things:

1. How small and fast the *draft model* is compared with the *main model*
...
1\. Discrete Example: Mathematical Question [#1-discrete-example-mathematical-question]
...
2\. Creative Example: Story Generation [#2-creative-example-story-generation]
...
Option 1: llmster (recommended) [#option-1-llmster-recommended]
...
Ephemeral MCP servers [#ephemeral-mcp-servers]
...
MCP servers from mcp.json [#mcp-servers-from-mcpjson]
...
Custom headers for ephemeral servers [#custom-headers-for-ephemeral-servers]
...
Load a `<model>` with a TTL of 1 hour (3600 seconds) [#load-a-model-with-a-ttl-of-1-hour-3600-seconds]
...
<DocsHStack>
  <DocsHStackLeft>
    ...
    **Request body**
    ...
    <DocsParamsTable data="-%20name%3A%20model%0A%20%20type%3A%20string%0A%20%20optional%3A%20false%0A%20%20description%3A%20Unique%20identifier%20for%20the%20model%20to%20use.%0A-%20name%3A%20input%0A%20%20type%3A%20string%20%7C%20array%3Cobject%3E%0A%20%20optional%3A%20false%0A%20%20description%3A%20Message%20to%20send%20to%20the%20model.%0A%20%20children%3A%0A%20%20%20%20-%20name%3A%20Input%20text%0A%20%20%20%20%20%20unstyledName%3A%20true%0A%20%20%20%20%20%20type%3A%20string%0A%20%20%20%20%20%20description%3A%20Text%20content%20of%20the%20message.%0A%20%20%20%20-%20name%3A%20Input%20object%0A%20%20%20%20%20%20unstyledName%3A%20true%0A%20%20%20%20%20%20type%3A%20object%0A%20%20%20%20%20%20description%3A%20Object%20representing%20a%20message%20with%20additional%20metadata.%0A%20%20%20%20%20%20children%3A%0A%20%20%20%20%20%20%20%20-%20name%3A%20Text%20Input%0A%20%20%20%20%20%20%20%20%20%20type%3A%20object%0A%20%20%20%20%20%20%20%20%20%20optional%3A%20true%0A%20%20%20%20%20%20%20%20%20%20description%3A%20Text%20input%20to%20provide%20user%20messages%0A%20%20%20%20%20%20%20%20%20%20children%3A%0A%20%20%20%20%20%20%20%20%20%20%20%20-%20name%3A%20type%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20type%3A%20'%22message%22'%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20optional%3A%20false%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20description%3A%20Type%20of%20input%20item.%0A%20%20%20%20%20%20%20%20%20%20%20%20-%20name%3A%20content%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20type%3A%20string%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20description%3A%20Text%20content%20of%20the%20message.%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20optional%3A%20false%0A%20%20%20%20%20%20%20%20-%20name%3A%20Image%20Input%0A%20%20%20%20%20%20%20%20%20%20type%3A%20object%0A%20%20%20%20%20%20%20%20%20%20optional%3A%20true%0A%20%20%20%20%20%20%20%20%20%20description%3A%20Image%20input%20to%20provide%20user%20messages%0A%20%20%20%20%20%20%20%20%20%20children%3A%0A%20%20%20%20%20%20%20%20%20%20%20%20-%20name%3A%20type%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20type%3A%20'%22image%22'%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20optional%3A%20false%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20description%3A%20Type%20of%20input%20item.%0A%20%20%20%20%20%20%20%20%20%20%20%20-%20name%3A%20data_url%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20type%3A%20string%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20description%3A%20Image%20data%20as%20a%20base64-encoded%20data%20URL.%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20optional%3A%20false%0A-%20name%3A%20system_prompt%0A%20%20type%3A%20string%0A%20%20optional%3A%20true%0A%20%20description%3A%20System%20message%20that%20sets%20model%20behavior%20or%20instructions.%0A-%20name%3A%20integrations%0A%20%20type%3A%20array%3Cstring%20%7C%20object%3E%0A%20%20optional%3A%20true%0A%20%20description%3A%20List%20of%20integrations%20(plugins%2C%20ephemeral%20MCP%20servers%2C%20etc...)%20to%20enable%20for%20this%20request.%0A%20%20children%3A%0A%20%20%20%20-%20name%3A%20Plugin%20id%0A%20%20%20%20%20%20unstyledName%3A%20true%0A%20%20%20%20%20%20type%3A%20string%0A%20%20%20%20%20%20description%3A%20Unique%20identifier%20of%20a%20plugin%20to%20use.%20Plugins%20contain%20%60mcp.json%60%20installed%20MCP%20servers%20(id%20%60mcp%2F%3Cserver_label%3E%60).%20Shorthand%20for%20plugin%20object%20with%20no%20custom%20configuration.%0A%20%20%20%20-%20name%3A%20Plugin%0A%20%20%20%20%20%20unstyledName%3A%20true%0A%20%20%20%20%20%20type%3A%20object%0A%20%20%20%20%20%20description%3A%20Specification%20of%20a%20plugin%20to%20use.%20Plugins%20contain%20%60mcp.json%60%20installed%20MCP%20servers%20(id%20%60mcp%2F%3Cserver_label%3E%60).%0A%20%20%20%20%20%20children%3A%0A%20%20%20%20%20%20%20%20-%20name%3A%20type%0A%20%20%20%20%20%20%20%20%20%20type%3A%20'%22plugin%22'%0A%20%20%20%20%20%20%20%20%20%20optional%3A%20false%0A%20%20%20%20%20%20%20%20%20%20description%3A%20Type%20of%20integration.%0A%20%20%20%20%20%20%20%20-%20name%3A%20id%0A%20%20%20%20%20%20%20%20%20%20type%3A%20string%0A%20%20%20%20%20%20%20%20%20%20optional%3A%20false%0A%20%20%20%20%20%20%20%20%20%20description%3A%20Unique%20identifier%20of%20the%20plugin.%0A%20%20%20%20%20%20%20%20-%20name%3A%20allowed_tools%0A%20%20%20%20%20%20%20%20%20%20type%3A%20array%3Cstring%3E%0A%20%20%20%20%20%20%20%20%20%20optional%3A%20true%0A%20%20%20%20%20%20%20%20%20%20description%3A%20List%20of%20tool%20names%20the%20model%20can%20call%20from%20this%20plugin.%20If%20not%20provided%2C%20all%20tools%20from%20the%20plugin%20are%20allowed.%0A%20%20%20%20-%20name%3A%20Ephemeral%20MCP%20server%20specification%0A%20%20%20%20%20%20unstyledName%3A%20true%0A%20%20%20%20%20%20type%3A%20object%0A%20%20%20%20%20%20description%3A%20Specification%20of%20an%20ephemeral%20MCP%20server.%20Allows%20defining%20MCP%20servers%20on-the-fly%20without%20needing%20to%20pre-configure%20them%20in%20your%20%60mcp.json%60.%0A%20%20%20%20%20%20children%3A%0A%20%20%20%20%20%20%20%20-%20name%3A%20type%0A%20%20%20%20%20%20%20%20%20%20type%3A%20'%22ephemeral_mcp%22'%0A%20%20%20%20%20%20%20%20%20%20optional%3A%20false%0A%20%20%20%20%20%20%20%20%20%20description%3A%20Type%20of%20integration.%0A%20%20%20%20%20%20%20%20-%20name%3A%20server_label%0A%20%20%20%20%20%20%20%20%20%20type%3A%20string%0A%20%20%20%20%20%20%20%20%20%20optional%3A%20false%0A%20%20%20%20%20%20%20%20%20%20description%3A%20Label%20to%20identify%20the%20MCP%20server.%0A%20%20%20%20%20%20%20%20-%20name%3A%20server_url%0A%20%20%20%20%20%20%20%20%20%20type%3A%20string%0A%20%20%20%20%20%20%20%20%20%20optional%3A%20false%0A%20%20%20%20%20%20%20%20%20%20description%3A%20URL%20of%20the%20MCP%20server.%0A%20%20%20%20%20%20%20%20-%20name%3A%20allowed_tools%0A%20%20%20%20%20%20%20%20%20%20type%3A%20array%3Cstring%3E%0A%20%20%20%20%20%20%20%20%20%20optional%3A%20true%0A%20%20%20%20%20%20%20%20%20%20description%3A%20List%20of%20tool%20names%20the%20model%20can%20call%20from%20this%20server.%20If%20not%20provided%2C%20all%20tools%20from%20the%20server%20are%20allowed.%0A%20%20%20%20%20%20%20%20-%20name%3A%20headers%0A%20%20%20%20%20%20%20%20%20%20type%3A%20object%0A%20%20%20%20%20%20%20%20%20%20optional%3A%20true%0A%20%20%20%20%20%20%20%20%20%20description%3A%20Custom%20HTTP%20headers%20to%20send%20with%20requests%20to%20the%20server.%0A-%20name%3A%20stream%0A%20%20type%3A%20boolean%0A%20%20optional%3A%20true%0A%20%20description%3A%20Whether%20to%20stream%20partial%20outputs%20via%20SSE.%20Default%20%60false%60.%20See%20%5Bstreaming%20events%5D(%2Fdocs%2Fdeveloper%2Frest%2Fstreaming-events)%20for%20more%20information.%0A-%20name%3A%20temperature%0A%20%20type%3A%20number%0A%20%20optional%3A%20true%0A%20%20description%3A%20Randomness%20in%20token%20selection.%200%20is%20deterministic%2C%20higher%20values%20increase%20creativity%20%5B0%2C1%5D.%0A-%20name%3A%20top_p%0A%20%20type%3A%20number%0A%20%20optional%3A%20true%0A%20%20description%3A%20Minimum%20cumulative%20probability%20for%20the%20possible%20next%20tokens%20%5B0%2C1%5D.%0A-%20name%3A%20top_k%0A%20%20type%3A%20integer%0A%20%20optional%3A%20true%0A%20%20description%3A%20Limits%20next%20token%20selection%20to%20top-k%20most%20probable%20tokens.%0A-%20name%3A%20min_p%0A%20%20type%3A%20number%0A%20%20optional%3A%20true%0A%20%20description%3A%20Minimum%20base%20probability%20for%20a%20token%20to%20be%20selected%20for%20output%20%5B0%2C1%5D.%0A-%20name%3A%20repeat_penalty%0A%20%20type%3A%20number%0A%20%20optional%3A%20true%0A%20%20description%3A%20Penalty%20for%20repeating%20token%20sequences.%201%20is%20no%20penalty%2C%20higher%20values%20discourage%20repetition.%0A-%20name%3A%20max_output_tokens%0A%20%20type%3A%20integer%0A%20%20optional%3A%20true%0A%20%20description%3A%20Maximum%20number%20of%20tokens%20to%20generate.%0A-%20name%3A%20reasoning%0A%20%20type%3A%20'%22off%22%20%7C%20%22low%22%20%7C%20%22medium%22%20%7C%20%22high%22%20%7C%20%22on%22'%0A%20%20optional%3A%20true%0A%20%20description%3A%20Reasoning%20setting.%20Will%20error%20if%20the%20model%20being%20used%20does%20not%20support%20the%20reasoning%20setting%20using.%20Defaults%20to%20the%20automatically%20chosen%20setting%20for%20the%20model.%0A-%20name%3A%20context_length%0A%20%20type%3A%20integer%0A%20%20optional%3A%20true%0A%20%20description%3A%20Number%20of%20tokens%20to%20consider%20as%20context.%20Higher%20values%20recommended%20for%20MCP%20usage.%0A-%20name%3A%20store%0A%20%20type%3A%20boolean%0A%20%20optional%3A%20true%0A%20%20description%3A%20Whether%20to%20store%20the%20chat.%20If%20set%2C%20response%20will%20return%20a%20%60%22response_id%22%60%20field.%20Default%20%60true%60.%0A-%20name%3A%20previous_response_id%0A%20%20type%3A%20string%0A%20%20optional%3A%20true%0A%20%20description%3A%20Identifier%20of%20existing%20response%20to%20append%20to.%20Must%20start%20with%20%60%22resp_%22%60." />
  </DocsHStackLeft>

  <DocsHStackRight>
    <CodeBlockTabs defaultValue="Request with MCP">
      <CodeBlockTabsList>
        <CodeBlockTabsTrigger value="Request with MCP">
          Request with MCP
        </CodeBlockTabsTrigger>

        <CodeBlockTabsTrigger value="Request with Images">
          Request with Images
        </CodeBlockTabsTrigger>
      </CodeBlockTabsList>

      <CodeBlockTab value="Request with MCP">
        ```bash
        curl http://localhost:1234/api/v1/chat \
          -H "Authorization: Bearer $LM_API_TOKEN" \
          -H "Content-Type: application/json" \
      ...
      <CodeBlockTab value="Request with Images">
        ```bash
...
<DocsHStack>
  <DocsHStackLeft>
    **Response fields**
    ...
    <DocsParamsTable data="-%20name%3A%20model_instance_id%0A%20%20type%3A%20string%0A%20%20description%3A%20Unique%20identifier%20for%20the%20loaded%20model%20instance%20that%20generated%20the%20response.%0A-%20name%3A%20output%0A%20%20type%3A%20array%3Cobject%3E%0A%20%20description%3A%20Array%20of%20output%20items%20generated.%20Each%20item%20can%20be%20one%20of%20three%20types.%0A%20%20children%3A%0A%20%20%20%20-%20name%3A%20Message%0A%20%20%20%20%20%20unstyledName%3A%20true%0A%20%20%20%20%20%20type%3A%20object%0A%20%20%20%20%20%20description%3A%20A%20text%20message%20from%20the%20model.%0A%20%20%20%20%20%20children%3A%0A%20%20%20%20%20%20%20%20-%20name%3A%20type%0A%20%20%20%20%20%20%20%20%20%20type%3A%20'%22message%22'%0A%20%20%20%20%20%20%20%20%20%20description%3A%20Type%20of%20output%20item.%0A%20%20%20%20%20%20%20%20-%20name%3A%20content%0A%20%20%20%20%20%20%20%20%20%20type%3A%20string%0A%20%20%20%20%20%20%20%20%20%20description%3A%20Text%20content%20of%20the%20message.%0A%20%20%20%20-%20name%3A%20Tool%20call%0A%20%20%20%20%20%20unstyledName%3A%20true%0A%20%20%20%20%20%20type%3A%20object%0A%20%20%20%20%20%20description%3A%20A%20tool%20call%20made%20by%20the%20model.%0A%20%20%20%20%20%20children%3A%0A%20%20%20%20%20%20%20%20-%20name%3A%20type%0A%20%20%20%20%20%20%20%20%20%20type%3A%20'%22tool_call%22'%0A%20%20%20%20%20%20%20%20%20%20description%3A%20Type%20of%20output%20item.%0A%20%20%20%20%20%20%20%20-%20name%3A%20tool%0A%20%20%20%20%20%20%20%20%20%20type%3A%20string%0A%20%20%20%20%20%20%20%20%20%20description%3A%20Name%20of%20the%20tool%20called.%0A%20%20%20%20%20%20%20%20-%20name%3A%20arguments%0A%20%20%20%20%20%20%20%20%20%20type%3A%20object%0A%20%20%20%20%20%20%20%20%20%20description%3A%20Arguments%20passed%20to%20the%20tool.%20Can%20have%20any%20keys%2Fvalues%20depending%20on%20the%20tool%20definition.%0A%20%20%20%20%20%20%20%20-%20name%3A%20output%0A%20%20%20%20%20%20%20%20%20%20type%3A%20string%0A%20%20%20%20%20%20%20%20%20%20description%3A%20Result%20returned%20from%20the%20tool.%0A%20%20%20%20%20%20%20%20-%20name%3A%20provider_info%0A%20%20%20%20%20%20%20%20%20%20type%3A%20object%0A%20%20%20%20%20%20%20%20%20%20description%3A%20Information%20about%20the%20tool%20provider.%0A%20%20%20%20%20%20%20%20%20%20children%3A%0A%20%20%20%20%20%20%20%20%20%20%20%20-%20name%3A%20type%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20type%3A%20'%22plugin%22%20%7C%20%22ephemeral_mcp%22'%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20description%3A%20Provider%20type.%0A%20%20%20%20%20%20%20%20%20%20%20%20-%20name%3A%20plugin_id%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20type%3A%20string%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20optional%3A%20true%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20description%3A%20Identifier%20of%20the%20plugin%20(when%20%60type%60%20is%20%60%22plugin%22%60).%0A%20%20%20%20%20%20%20%20%20%20%20%20-%20name%3A%20server_label%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20type%3A%20string%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20optional%3A%20true%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20description%3A%20Label%20of%20the%20MCP%20server%20(when%20%60type%60%20is%20%60%22ephemeral_mcp%22%60).%0A%20%20%20%20-%20name%3A%20Reasoning%0A%20%20%20%20%20%20unstyledName%3A%20true%0A%20%20%20%20%20%20type%3A%20object%0A%20%20%20%20%20%20description%3A%20Reasoning%20content%20from%20the%20model.%0A%20%20%20%20%20%20children%3A%0A%20%20%20%20%20%20%20%20-%20name%3A%20type%0A%20%20%20%20%20%20%20%20%20%20type%3A%20'%22reasoning%22'%0A%20%20%20%20%20%20%20%20%20%20description%3A%20Type%20of%20output%20item.%0A%20%20%20%20%20%20%20%20-%20name%3A%20content%0A%20%20%20%20%20%20%20%20%20%20type%3A%20string%0A%20%20%20%20%20%20%20%20%20%20description%3A%20Text%20content%20of%20the%20reasoning.%0A%20%20%20%20-%20name%3A%20Invalid%20tool%20call%0A%20%20%20%20%20%20unstyledName%3A%20true%0A%20%20%20%20%20%20type%3A%20object%0A%20%20%20%20%20%20description%3A%20An%20invalid%20tool%20call%20made%20by%20the%20model%20-%20due%20to%20invalid%20tool%20name%20or%20tool%20arguments.%0A%20%20%20%20%20%20children%3A%0A%20%20%20%20%20%20%20%20-%20name%3A%20type%0A%20%20%20%20%20%20%20%20%20%20type%3A%20'%22invalid_tool_call%22'%0A%20%20%20%20%20%20%20%20%20%20description%3A%20Type%20of%20output%20item.%0A%20%20%20%20%20%20%20%20-%20name%3A%20reason%0A%20%20%20%20%20%20%20%20%20%20type%3A%20string%0A%20%20%20%20%20%20%20%20%20%20description%3A%20Reason%20why%20the%20tool%20call%20was%20invalid.%0A%20%20%20%20%20%20%20%20-%20name%3A%20metadata%0A%20%20%20%20%20%20%20%20%20%20type%3A%20object%0A%20%20%20%20%20%20%20%20%20%20description%3A%20Metadata%20about%20the%20invalid%20tool%20call.%0A%20%20%20%20%20%20%20%20%20%20children%3A%0A%20%20%20%20%20%20%20%20%20%20%20%20-%20name%3A%20type%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20type%3A%20'%22invalid_name%22%20%7C%20%22invalid_arguments%22'%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20description%3A%20Type%20of%20error%20that%20occurred.%0A%20%20%20%20%20%20%20%20%20%20%20%20-%20name%3A%20tool_name%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20type%3A%20string%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20description%3A%20Name%20of%20the%20tool%20that%20was%20attempted%20to%20be%20called.%0A%20%20%20%20%20%20%20%20%20%20%20%20-%20name%3A%20arguments%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20type%3A%20object%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20optional%3A%20true%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20description%3A%20Arguments%20that%20were%20passed%20to%20the%20tool%20(only%20present%20for%20%60invalid_arguments%60%20errors).%0A%20%20%20%20%20%20%20%20%20%20%20%20-%20name%3A%20provider_info%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20type%3A%20object%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20optional%3A%20true%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20description%3A%20Information%20about%20the%20tool%20provider%20(only%20present%20for%20%60invalid_arguments%60%20errors).%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20children%3A%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20-%20name%3A%20type%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20type%3A%20'%22plugin%22%20%7C%20%22ephemeral_mcp%22'%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20description%3A%20Provider%20type.%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20-%20name%3A%20plugin_id%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20type%3A%20string%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20optional%3A%20true%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20description%3A%20Identifier%20of%20the%20plugin%20(when%20%60type%60%20is%20%60%22plugin%22%60).%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20-%20name%3A%20server_label%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20type%3A%20string%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20optional%3A%20true%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20description%3A%20Label%20of%20the%20MCP%20server%20(when%20%60type%60%20is%20%60%22ephemeral_mcp%22%60).%0A-%20name%3A%20stats%0A%20%20type%3A%20object%0A%20%20description%3A%20Token%20usage%20and%20performance%20metrics.%0A%20%20children%3A%0A%20%20%20%20-%20name%3A%20input_tokens%0A%20%20%20%20%20%20type%3A%20number%0A%20%20%20%20%20%20description%3A%20Number%20of%20input%20tokens.%20Includes%20formatting%2C%20tool%20definitions%2C%20and%20prior%20messages%20in%20the%20chat.%0A%20%20%20%20-%20name%3A%20total_output_tokens%0A%20%20%20%20%20%20type%3A%20number%0A%20%20%20%20%20%20description%3A%20Total%20number%20of%20output%20tokens%20generated.%0A%20%20%20%20-%20name%3A%20reasoning_output_tokens%0A%20%20%20%20%20%20type%3A%20number%0A%20%20%20%20%20%20description%3A%20Number%20of%20tokens%20used%20for%20reasoning.%0A%20%20%20%20-%20name%3A%20tokens_per_second%0A%20%20%20%20%20%20type%3A%20number%0A%20%20%20%20%20%20description%3A%20Generation%20speed%20in%20tokens%20per%20second.%0A%20%20%20%20-%20name%3A%20time_to_first_token_seconds%0A%20%20%20%20%20%20type%3A%20number%0A%20%20%20%20%20%20description%3A%20Time%20in%20seconds%20to%20generate%20the%20first%20token.%0A%20%20%20%20-%20name%3A%20model_load_time_seconds%0A%20%20%20%20%20%20type%3A%20number%0A%20%20%20%20%20%20optional%3A%20true%0A%20%20%20%20%20%20description%3A%20Time%20taken%20to%20load%20the%20model%20for%20this%20request%20in%20seconds.%20Present%20only%20if%20the%20model%20was%20not%20already%20loaded.%0A-%20name%3A%20response_id%0A%20%20type%3A%20string%0A%20%20optional%3A%20true%0A%20%20description%3A%20Identifier%20of%20the%20response%20for%20subsequent%20requests.%20Starts%20with%20%60%22resp_%22%60.%20Present%20when%20%60store%60%20is%20%60true%60." />
  </DocsHStackLeft>
...
<DocsHStack>
  <DocsHStackLeft>
    ...
    **Path parameters**
    ...
    <DocsParamsTable data="-%20name%3A%20job_id%0A%20%20type%3A%20string%0A%20%20optional%3A%20false%0A%20%20description%3A%20The%20unique%20identifier%20of%20the%20download%20job.%20%60job_id%60%20is%20returned%20by%20the%20%5Bdownload%5D(%2Fdocs%2Fdeveloper%2Frest%2Fdownload)%20endpoint%20when%20a%20download%20is%20initiated." />
  </DocsHStackLeft>
...
<DocsHStack>
  <DocsHStackLeft>
    **Response fields**
    ...
    <DocsParamsTable data="-%20name%3A%20job_id%0A%20%20type%3A%20string%0A%20%20description%3A%20Unique%20identifier%20for%20the%20download%20job.%0A-%20name%3A%20status%0A%20%20type%3A%20'%22downloading%22%20%7C%20%22paused%22%20%7C%20%22completed%22%20%7C%20%22failed%22'%0A%20%20description%3A%20Current%20status%20of%20the%20download.%0A-%20name%3A%20bytes_per_second%0A%20%20type%3A%20number%0A%20%20optional%3A%20true%0A%20%20description%3A%20Current%20download%20speed%20in%20bytes%20per%20second.%20Present%20when%20%60status%60%20is%20%60downloading%60.%0A-%20name%3A%20estimated_completion%0A%20%20type%3A%20string%0A%20%20optional%3A%20true%0A%20%20description%3A%20Estimated%20completion%20time%20in%20ISO%208601%20format.%20Present%20when%20%60status%60%20is%20%60downloading%60.%0A-%20name%3A%20completed_at%0A%20%20type%3A%20string%0A%20%20optional%3A%20true%0A%20%20description%3A%20Download%20completion%20time%20in%20ISO%208601%20format.%20Present%20when%20%60status%60%20is%20%60completed%60.%0A-%20name%3A%20total_size_bytes%0A%20%20type%3A%20number%0A%20%20optional%3A%20true%0A%20%20description%3A%20Total%20size%20of%20the%20download%20in%20bytes.%0A-%20name%3A%20downloaded_bytes%0A%20%20type%3A%20number%0A%20%20optional%3A%20true%0A%20%20description%3A%20Number%20of%20bytes%20downloaded%20so%20far.%0A-%20name%3A%20started_at%0A%20%20type%3A%20string%0A%20%20optional%3A%20true%0A%20%20description%3A%20Download%20start%20time%20in%20ISO%208601%20format." />
  </DocsHStackLeft>
...
<DocsHStack>
  <DocsHStackLeft>
    ...
    **Request body**
    ...
    <DocsParamsTable data="-%20name%3A%20model%0A%20%20type%3A%20string%0A%20%20optional%3A%20false%0A%20%20description%3A%20The%20model%20to%20download.%20Accepts%20%5Bmodel%20catalog%5D(https%3A%2F%2Flmstudio.ai%2Fmodels)%20identifiers%20(e.g.%2C%20%60openai%2Fgpt-oss-20b%60)%20and%20exact%20Hugging%20Face%20links%20(e.g.%2C%20%60https%3A%2F%2Fhuggingface.co%2Flmstudio-community%2Fgpt-oss-20b-GGUF%60)%0A-%20name%3A%20quantization%0A%20%20type%3A%20string%0A%20%20optional%3A%20true%0A%20%20description%3A%20Quantization%20level%20of%20the%20model%20to%20download%20(e.g.%2C%20%60Q4_K_M%60).%20Only%20supported%20for%20Hugging%20Face%20links." />
  </DocsHStackLeft>
...
<DocsHStack>
  <DocsHStackLeft>
    **Response fields**
    ...
    <DocsParamsTable data="-%20name%3A%20job_id%0A%20%20type%3A%20string%0A%20%20optional%3A%20true%0A%20%20description%3A%20Unique%20identifier%20for%20the%20download%20job.%20Absent%20when%20%60status%60%20is%20%60already_downloaded%60.%0A-%20name%3A%20status%0A%20%20type%3A%20'%22downloading%22%20%7C%20%22paused%22%20%7C%20%22completed%22%20%7C%20%22failed%22%20%7C%20%22already_downloaded%22'%0A%20%20description%3A%20Current%20status%20of%20the%20download.%0A-%20name%3A%20completed_at%0A%20%20type%3A%20string%0A%20%20optional%3A%20true%0A%20%20description%3A%20Download%20completion%20time%20in%20ISO%208601%20format.%20Present%20when%20%60status%60%20is%20%60completed%60.%0A-%20name%3A%20total_size_bytes%0A%20%20type%3A%20number%0A%20%20optional%3A%20true%0A%20%20description%3A%20Total%20size%20of%20the%20download%20in%20bytes.%20Absent%20when%20%60status%60%20is%20%60already_downloaded%60.%0A-%20name%3A%20started_at%0A%20%20type%3A%20string%0A%20%20optional%3A%20true%0A%20%20description%3A%20Download%20start%20time%20in%20ISO%208601%20format.%20Absent%20when%20%60status%60%20is%20%60already_downloaded%60." />
  </DocsHStackLeft>
...
<table className="flexible-cols">
  ...
  <tbody>
    <tr>
      ...
      <td>
        <a href="/docs/developer/rest/chat">Chat</a>
      </td>
    </tr>

    <tr>
      <td>
        <code>/api/v1/models</code>
      </td>
      ...
      <td>
        <a href="/docs/developer/rest/list">List Models</a>
      </td>
    </tr>

    <tr>
      <td>
        <code>/api/v1/models/load</code>
      </td>
      ...
      <td>
        <a href="/docs/developer/rest/load">Load</a>
      </td>
    </tr>

    <tr>
      <td>
        <code>/api/v1/models/unload</code>
      </td>
      ...
      <td>
        <a href="/docs/developer/rest/unload">Unload</a>
      </td>
    </tr>

    <tr>
      <td>
        <code>/api/v1/models/download</code>
      </td>
      ...
      <td>
        <a href="/docs/developer/rest/download">Download</a>
      </td>
    </tr>

    <tr>
      <td>
        <code>/api/v1/models/download/status</code>
      </td>
      ...
      <td>
        <a href="/docs/developer/rest/download-status">Download Status</a>
      </td>
    </tr>
  </tbody>
</table>
...
<table className="flexible-cols">
  <thead>
    <tr>
      ...
      <th>
        <a href="/docs/developer/rest/chat"><code>/api/v1/chat</code></a>
      </th>

      <th>
        <a href="/docs/developer/openai-compat/responses"><code>/v1/responses</code></a>
      </th>

      <th>
        <a href="/docs/developer/openai-compat/chat-completions"><code>/v1/chat/completions</code></a>
      </th>

      <th>
        <a href="/docs/developer/anthropic-compat/messages"><code>/v1/messages</code></a>
      </th>
    </tr>
  </thead>
...
<DocsHStack>
  <DocsHStackLeft>
    **Response fields**
    ...
    <DocsParamsTable data="-%20name%3A%20models%0A%20%20type%3A%20array%0A%20%20description%3A%20List%20of%20available%20models%20(both%20LLMs%20and%20embedding%20models).%0A%20%20children%3A%0A%20%20%20%20-%20name%3A%20type%0A%20%20%20%20%20%20type%3A%20'%22llm%22%20%7C%20%22embedding%22'%0A%20%20%20%20%20%20description%3A%20Type%20of%20model.%0A%20%20%20%20-%20name%3A%20publisher%0A%20%20%20%20%20%20type%3A%20string%0A%20%20%20%20%20%20description%3A%20Model%20publisher%20name.%0A%20%20%20%20-%20name%3A%20key%0A%20%20%20%20%20%20type%3A%20string%0A%20%20%20%20%20%20description%3A%20Unique%20identifier%20for%20the%20model.%0A%20%20%20%20-%20name%3A%20display_name%0A%20%20%20%20%20%20type%3A%20string%0A%20%20%20%20%20%20description%3A%20Human-readable%20model%20name.%0A%20%20%20%20-%20name%3A%20architecture%0A%20%20%20%20%20%20type%3A%20string%20%7C%20null%0A%20%20%20%20%20%20optional%3A%20true%0A%20%20%20%20%20%20description%3A%20Model%20architecture%20(e.g.%2C%20%22llama%22%2C%20%22mistral%22).%20Absent%20for%20embedding%20models.%0A%20%20%20%20-%20name%3A%20quantization%0A%20%20%20%20%20%20type%3A%20object%20%7C%20null%0A%20%20%20%20%20%20description%3A%20Quantization%20information%20for%20the%20model.%0A%20%20%20%20%20%20children%3A%0A%20%20%20%20%20%20%20%20-%20name%3A%20name%0A%20%20%20%20%20%20%20%20%20%20type%3A%20string%20%7C%20null%0A%20%20%20%20%20%20%20%20%20%20description%3A%20Quantization%20method%20name.%0A%20%20%20%20%20%20%20%20-%20name%3A%20bits_per_weight%0A%20%20%20%20%20%20%20%20%20%20type%3A%20number%20%7C%20null%0A%20%20%20%20%20%20%20%20%20%20description%3A%20Bits%20per%20weight%20for%20the%20quantization.%0A%20%20%20%20-%20name%3A%20size_bytes%0A%20%20%20%20%20%20type%3A%20number%0A%20%20%20%20%20%20description%3A%20Size%20of%20the%20model%20in%20bytes.%0A%20%20%20%20-%20name%3A%20params_string%0A%20%20%20%20%20%20type%3A%20string%20%7C%20null%0A%20%20%20%20%20%20description%3A%20Human-readable%20parameter%20count%20(e.g.%2C%20%227B%22%2C%20%2213B%22).%0A%20%20%20%20-%20name%3A%20loaded_instances%0A%20%20%20%20%20%20type%3A%20array%0A%20%20%20%20%20%20description%3A%20List%20of%20currently%20loaded%20instances%20of%20this%20model.%0A%20%20%20%20%20%20children%3A%0A%20%20%20%20%20%20%20%20-%20name%3A%20id%0A%20%20%20%20%20%20%20%20%20%20type%3A%20string%0A%20%20%20%20%20%20%20%20%20%20description%3A%20Unique%20identifier%20for%20the%20loaded%20model%20instance.%0A%20%20%20%20%20%20%20%20-%20name%3A%20config%0A%20%20%20%20%20%20%20%20%20%20type%3A%20object%0A%20%20%20%20%20%20%20%20%20%20description%3A%20Configuration%20for%20the%20loaded%20instance.%0A%20%20%20%20%20%20%20%20%20%20children%3A%0A%20%20%20%20%20%20%20%20%20%20%20%20-%20name%3A%20context_length%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20type%3A%20number%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20description%3A%20The%20maximum%20context%20length%20for%20the%20model%20in%20number%20of%20tokens.%0A%20%20%20%20%20%20%20%20%20%20%20%20-%20name%3A%20eval_batch_size%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20type%3A%20number%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20optional%3A%20true%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20description%3A%20Number%20of%20input%20tokens%20to%20process%20together%20in%20a%20single%20batch%20during%20evaluation.%20Absent%20for%20embedding%20models.%0A%20%20%20%20%20%20%20%20%20%20%20%20-%20name%3A%20parallel%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20type%3A%20number%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20optional%3A%20true%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20description%3A%20Maximum%20number%20of%20parallel%20predictions%20the%20instance%20can%20handle.%20Absent%20for%20embedding%20models.%0A%20%20%20%20%20%20%20%20%20%20%20%20-%20name%3A%20flash_attention%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20type%3A%20boolean%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20optional%3A%20true%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20description%3A%20Whether%20Flash%20Attention%20is%20enabled%20for%20optimized%20attention%20computation.%20Absent%20for%20embedding%20models.%0A%20%20%20%20%20%20%20%20%20%20%20%20-%20name%3A%20num_experts%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20type%3A%20number%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20optional%3A%20true%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20description%3A%20Number%20of%20experts%20for%20MoE%20(Mixture%20of%20Experts)%20models.%20Absent%20for%20embedding%20models.%0A%20%20%20%20%20%20%20%20%20%20%20%20-%20name%3A%20offload_kv_cache_to_gpu%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20type%3A%20boolean%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20optional%3A%20true%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20description%3A%20Whether%20KV%20cache%20is%20offloaded%20to%20GPU%20memory.%20Absent%20for%20embedding%20models.%0A%20%20%20%20-%20name%3A%20max_context_length%0A%20%20%20%20%20%20type%3A%20number%0A%20%20%20%20%20%20description%3A%20Maximum%20context%20length%20supported%20by%20the%20model%20in%20number%20of%20tokens.%0A%20%20%20%20-%20name%3A%20format%0A%20%20%20%20%20%20type%3A%20'%22gguf%22%20%7C%20%22mlx%22%20%7C%20null'%0A%20%20%20%20%20%20description%3A%20Model%20file%20format.%0A%20%20%20%20-%20name%3A%20capabilities%0A%20%20%20%20%20%20type%3A%20object%0A%20%20%20%20%20%20optional%3A%20true%0A%20%20%20%20%20%20description%3A%20Model%20capabilities.%20Absent%20for%20embedding%20models.%0A%20%20%20%20%20%20children%3A%0A%20%20%20%20%20%20%20%20-%20name%3A%20vision%0A%20%20%20%20%20%20%20%20%20%20type%3A%20boolean%0A%20%20%20%20%20%20%20%20%20%20description%3A%20Whether%20the%20model%20supports%20vision%2Fimage%20inputs.%0A%20%20%20%20%20%20%20%20-%20name%3A%20trained_for_tool_use%0A%20%20%20%20%20%20%20%20%20%20type%3A%20boolean%0A%20%20%20%20%20%20%20%20%20%20description%3A%20Whether%20the%20model%20was%20trained%20for%20tool%2Ffunction%20calling.%0A%20%20%20%20%20%20%20%20-%20name%3A%20reasoning%0A%20%20%20%20%20%20%20%20%20%20type%3A%20object%0A%20%20%20%20%20%20%20%20%20%20optional%3A%20true%0A%20%20%20%20%20%20%20%20%20%20description%3A%20Public%20reasoning%20configuration%20for%20the%20model.%20Absent%20when%20no%20reasoning%20config%20is%20exposed.%0A%20%20%20%20%20%20%20%20%20%20children%3A%0A%20%20%20%20%20%20%20%20%20%20%20%20-%20name%3A%20allowed_options%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20type%3A%20'(%22off%22%20%7C%20%22on%22%20%7C%20%22low%22%20%7C%20%22medium%22%20%7C%20%22high%22)%5B%5D'%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20description%3A%20Allowed%20public%20reasoning%20settings%20for%20the%20model.%0A%20%20%20%20%20%20%20%20%20%20%20%20-%20name%3A%20default%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20type%3A%20'%22off%22%20%7C%20%22on%22%20%7C%20%22low%22%20%7C%20%22medium%22%20%7C%20%22high%22'%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20description%3A%20Default%20public%20reasoning%20setting%20for%20the%20model.%0A%20%20%20%20-%20name%3A%20description%0A%20%20%20%20%20%20type%3A%20string%20%7C%20null%0A%20%20%20%20%20%20optional%3A%20true%0A%20%20%20%20%20%20description%3A%20Model%20description.%20Absent%20for%20embedding%20models.%0A%20%20%20%20-%20name%3A%20variants%0A%20%20%20%20%20%20type%3A%20array%0A%20%20%20%20%20%20optional%3A%20true%0A%20%20%20%20%20%20description%3A%20List%20of%20available%20quantization%20variant%20names%20for%20this%20model.%20Present%20for%20multi-variant%20models.%0A%20%20%20%20-%20name%3A%20selected_variant%0A%20%20%20%20%20%20type%3A%20string%0A%20%20%20%20%20%20optional%3A%20true%0A%20%20%20%20%20%20description%3A%20The%20currently%20selected%20variant%20name.%20Present%20when%20%60variants%60%20is%20present." />
  </DocsHStackLeft>
...
<DocsHStack>
  <DocsHStackLeft>
    ...
    **Request body**
    ...
    <DocsParamsTable data="-%20name%3A%20model%0A%20%20type%3A%20string%0A%20%20optional%3A%20false%0A%20%20description%3A%20Unique%20identifier%20for%20the%20model%20to%20load.%20Can%20be%20an%20LLM%20or%20embedding%20model.%0A-%20name%3A%20context_length%0A%20%20type%3A%20number%0A%20%20optional%3A%20true%0A%20%20description%3A%20Maximum%20number%20of%20tokens%20that%20the%20model%20will%20consider.%0A-%20name%3A%20eval_batch_size%0A%20%20type%3A%20number%0A%20%20optional%3A%20true%0A%20%20description%3A%20Number%20of%20input%20tokens%20to%20process%20together%20in%20a%20single%20batch%20during%20evaluation.%20Will%20only%20have%20an%20effect%20on%20LLMs%20loaded%20by%20LM%20Studio's%20%5Bllama.cpp%5D(https%3A%2F%2Fgithub.com%2Fggml-org%2Fllama.cpp)-based%20engine.%0A-%20name%3A%20flash_attention%0A%20%20type%3A%20boolean%0A%20%20optional%3A%20true%0A%20%20description%3A%20Whether%20to%20optimize%20attention%20computation.%20Can%20decrease%20memory%20usage%20and%20improved%20generation%20speed.%20Will%20only%20have%20an%20effect%20on%20LLMs%20loaded%20by%20LM%20Studio's%20%5Bllama.cpp%5D(https%3A%2F%2Fgithub.com%2Fggml-org%2Fllama.cpp)-based%20engine.%0A-%20name%3A%20num_experts%0A%20%20type%3A%20number%0A%20%20optional%3A%20true%0A%20%20description%3A%20Number%20of%20expert%20to%20use%20during%20inference%20for%20MoE%20(Mixture%20of%20Experts)%20models.%20Will%20only%20have%20an%20effect%20on%20MoE%20LLMs%20loaded%20by%20LM%20Studio's%20%5Bllama.cpp%5D(https%3A%2F%2Fgithub.com%2Fggml-org%2Fllama.cpp)-based%20engine.%0A-%20name%3A%20offload_kv_cache_to_gpu%0A%20%20type%3A%20boolean%0A%20%20optional%3A%20true%0A%20%20description%3A%20Whether%20KV%20cache%20is%20offloaded%20to%20GPU%20memory.%20If%20false%2C%20KV%20cache%20is%20stored%20in%20CPU%20memory%2FRAM.%20Will%20only%20have%20an%20effect%20on%20LLMs%20loaded%20by%20LM%20Studio's%20%5Bllama.cpp%5D(https%3A%2F%2Fgithub.com%2Fggml-org%2Fllama.cpp)-based%20engine.%0A-%20name%3A%20echo_load_config%0A%20%20type%3A%20boolean%0A%20%20optional%3A%20true%0A%20%20description%3A%20If%20true%2C%20echoes%20the%20final%20load%20configuration%20in%20the%20response%20under%20%60%22load_config%22%60.%20Default%20%60false%60." />
  </DocsHStackLeft>
...
<DocsHStack>
  <DocsHStackLeft>
    **Response fields**
    ...
    <DocsParamsTable data="-%20name%3A%20type%0A%20%20type%3A%20'%22llm%22%20%7C%20%22embedding%22'%0A%20%20description%3A%20Type%20of%20the%20loaded%20model.%0A-%20name%3A%20instance_id%0A%20%20type%3A%20string%0A%20%20description%3A%20Unique%20identifier%20for%20the%20loaded%20model%20instance.%0A-%20name%3A%20load_time_seconds%0A%20%20type%3A%20number%0A%20%20description%3A%20Time%20taken%20to%20load%20the%20model%20in%20seconds.%0A-%20name%3A%20status%0A%20%20type%3A%20'%22loaded%22'%0A%20%20description%3A%20Load%20status.%0A-%20name%3A%20load_config%0A%20%20type%3A%20object%0A%20%20optional%3A%20true%0A%20%20description%3A%20The%20final%20configuration%20applied%20to%20the%20loaded%20model.%20This%20may%20include%20settings%20that%20were%20not%20specified%20in%20the%20request.%20Included%20only%20when%20%60%22echo_load_config%22%60%20is%20%60true%60%20in%20the%20request.%0A%20%20children%3A%0A%20%20%20%20-%20name%3A%20LLM%20load%20config%0A%20%20%20%20%20%20unstyledName%3A%20true%0A%20%20%20%20%20%20type%3A%20object%0A%20%20%20%20%20%20description%3A%20Configuration%20parameters%20specific%20to%20LLM%20models.%20%60load_config%60%20will%20be%20this%20type%20when%20%60%22type%22%60%20is%20%60%22llm%22%60.%20Only%20parameters%20that%20applied%20to%20the%20load%20will%20be%20present.%0A%20%20%20%20%20%20children%3A%0A%20%20%20%20%20%20%20%20-%20name%3A%20context_length%0A%20%20%20%20%20%20%20%20%20%20type%3A%20number%0A%20%20%20%20%20%20%20%20%20%20optional%3A%20false%0A%20%20%20%20%20%20%20%20%20%20description%3A%20Maximum%20number%20of%20tokens%20that%20the%20model%20will%20consider.%0A%20%20%20%20%20%20%20%20-%20name%3A%20eval_batch_size%0A%20%20%20%20%20%20%20%20%20%20type%3A%20number%0A%20%20%20%20%20%20%20%20%20%20optional%3A%20true%0A%20%20%20%20%20%20%20%20%20%20description%3A%20Number%20of%20input%20tokens%20to%20process%20together%20in%20a%20single%20batch%20during%20evaluation.%20Only%20present%20for%20models%20loaded%20with%20LM%20Studio's%20%5Bllama.cpp%5D(https%3A%2F%2Fgithub.com%2Fggml-org%2Fllama.cpp)-based%20engine.%0A%20%20%20%20%20%20%20%20-%20name%3A%20flash_attention%0A%20%20%20%20%20%20%20%20%20%20type%3A%20boolean%0A%20%20%20%20%20%20%20%20%20%20optional%3A%20true%0A%20%20%20%20%20%20%20%20%20%20description%3A%20Whether%20Flash%20Attention%20is%20enabled%20for%20optimized%20attention%20computation.%20Only%20present%20for%20models%20loaded%20with%20LM%20Studio's%20%5Bllama.cpp%5D(https%3A%2F%2Fgithub.com%2Fggml-org%2Fllama.cpp)-based%20engine.%0A%20%20%20%20%20%20%20%20-%20name%3A%20num_experts%0A%20%20%20%20%20%20%20%20%20%20type%3A%20number%0A%20%20%20%20%20%20%20%20%20%20optional%3A%20true%0A%20%20%20%20%20%20%20%20%20%20description%3A%20Number%20of%20experts%20for%20MoE%20(Mixture%20of%20Experts)%20models.%20Only%20present%20for%20MoE%20models%20loaded%20with%20LM%20Studio's%20%5Bllama.cpp%5D(https%3A%2F%2Fgithub.com%2Fggml-org%2Fllama.cpp)-based%20engine.%0A%20%20%20%20%20%20%20%20-%20name%3A%20offload_kv_cache_to_gpu%0A%20%20%20%20%20%20%20%20%20%20type%3A%20boolean%0A%20%20%20%20%20%20%20%20%20%20optional%3A%20true%0A%20%20%20%20%20%20%20%20%20%20description%3A%20Whether%20KV%20cache%20is%20offloaded%20to%20GPU%20memory.%20Only%20present%20for%20models%20loaded%20with%20LM%20Studio's%20%5Bllama.cpp%5D(https%3A%2F%2Fgithub.com%2Fggml-org%2Fllama.cpp)-based%20engine.%0A%20%20%20%20-%20name%3A%20Embedding%20model%20load%20config%0A%20%20%20%20%20%20unstyledName%3A%20true%0A%20%20%20%20%20%20type%3A%20object%0A%20%20%20%20%20%20description%3A%20Configuration%20parameters%20specific%20to%20embedding%20models.%20%60load_config%60%20will%20be%20this%20type%20when%20%60%22type%22%60%20is%20%60%22embedding%22%60.%20Only%20parameters%20that%20applied%20to%20the%20load%20will%20be%20present.%0A%20%20%20%20%20%20children%3A%0A%20%20%20%20%20%20%20%20-%20name%3A%20context_length%0A%20%20%20%20%20%20%20%20%20%20type%3A%20number%0A%20%20%20%20%20%20%20%20%20%20optional%3A%20false%0A%20%20%20%20%20%20%20%20%20%20description%3A%20Maximum%20number%20of%20tokens%20that%20the%20model%20will%20consider." />
  </DocsHStackLeft>
...
<DocsHStack>
  <DocsHStackLeft>
    ...
    <DocsParamsTable data="-%20name%3A%20model_instance_id%0A%20%20type%3A%20string%0A%20%20description%3A%20Unique%20identifier%20for%20the%20loaded%20model%20instance%20that%20will%20generate%20the%20response.%0A-%20name%3A%20type%0A%20%20type%3A%20'%22chat.start%22'%0A%20%20description%3A%20The%20type%20of%20the%20event.%20Always%20%60chat.start%60." />
  </DocsHStackLeft>
...
<DocsHStack>
  <DocsHStackLeft>
    ...
    <DocsParamsTable data="-%20name%3A%20model_instance_id%0A%20%20type%3A%20string%0A%20%20description%3A%20Unique%20identifier%20for%20the%20model%20instance%20being%20loaded.%0A-%20name%3A%20type%0A%20%20type%3A%20'%22model_load.start%22'%0A%20%20description%3A%20The%20type%20of%20the%20event.%20Always%20%60model_load.start%60." />
  </DocsHStackLeft>
...
<DocsHStack>
  <DocsHStackLeft>
    ...
    <DocsParamsTable data="-%20name%3A%20model_instance_id%0A%20%20type%3A%20string%0A%20%20description%3A%20Unique%20identifier%20for%20the%20model%20instance%20being%20loaded.%0A-%20name%3A%20progress%0A%20%20type%3A%20number%0A%20%20description%3A%20Progress%20of%20the%20model%20load%20as%20a%20float%20between%20%600%60%20and%20%601%60.%0A-%20name%3A%20type%0A%20%20type%3A%20'%22model_load.progress%22'%0A%20%20description%3A%20The%20type%20of%20the%20event.%20Always%20%60model_load.progress%60." />
  </DocsHStackLeft>
...
<DocsHStack>
  <DocsHStackLeft>
    ...
    <DocsParamsTable data="-%20name%3A%20model_instance_id%0A%20%20type%3A%20string%0A%20%20description%3A%20Unique%20identifier%20for%20the%20model%20instance%20that%20was%20loaded.%0A-%20name%3A%20load_time_seconds%0A%20%20type%3A%20number%0A%20%20description%3A%20Time%20taken%20to%20load%20the%20model%20in%20seconds.%0A-%20name%3A%20type%0A%20%20type%3A%20'%22model_load.end%22'%0A%20%20description%3A%20The%20type%20of%20the%20event.%20Always%20%60model_load.end%60." />
  </DocsHStackLeft>
...
<DocsHStack>
  <DocsHStackLeft>
    ...
    <DocsParamsTable data="-%20name%3A%20type%0A%20%20type%3A%20'%22prompt_processing.start%22'%0A%20%20description%3A%20The%20type%20of%20the%20event.%20Always%20%60prompt_processing.start%60." />
  </DocsHStackLeft>
...
<DocsHStack>
  <DocsHStackLeft>
    ...
    <DocsParamsTable data="-%20name%3A%20progress%0A%20%20type%3A%20number%0A%20%20description%3A%20Progress%20of%20the%20prompt%20processing%20as%20a%20float%20between%20%600%60%20and%20%601%60.%0A-%20name%3A%20type%0A%20%20type%3A%20'%22prompt_processing.progress%22'%0A%20%20description%3A%20The%20type%20of%20the%20event.%20Always%20%60prompt_processing.progress%60." />
  </DocsHStackLeft>
...
<DocsHStack>
  <DocsHStackLeft>
    ...
    <DocsParamsTable data="-%20name%3A%20type%0A%20%20type%3A%20'%22prompt_processing.end%22'%0A%20%20description%3A%20The%20type%20of%20the%20event.%20Always%20%60prompt_processing.end%60." />
  </DocsHStackLeft>
...
<DocsHStack>
  <DocsHStackLeft>
    ...
    <DocsParamsTable data="-%20name%3A%20type%0A%20%20type%3A%20'%22reasoning.start%22'%0A%20%20description%3A%20The%20type%20of%20the%20event.%20Always%20%60reasoning.start%60." />
  </DocsHStackLeft>
...
<DocsHStack>
  <DocsHStackLeft>
    ...
    <DocsParamsTable data="-%20name%3A%20content%0A%20%20type%3A%20string%0A%20%20description%3A%20Reasoning%20text%20fragment.%0A-%20name%3A%20type%0A%20%20type%3A%20'%22reasoning.delta%22'%0A%20%20description%3A%20The%20type%20of%20the%20event.%20Always%20%60reasoning.delta%60." />
  </DocsHStackLeft>
...
<DocsHStack>
  <DocsHStackLeft>
    ...
    <DocsParamsTable data="-%20name%3A%20type%0A%20%20type%3A%20'%22reasoning.end%22'%0A%20%20description%3A%20The%20type%20of%20the%20event.%20Always%20%60reasoning.end%60." />
  </DocsHStackLeft>
...
<DocsHStack>
  <DocsHStackLeft>
    ...
    <DocsParamsTable data="-%20name%3A%20tool%0A%20%20type%3A%20string%0A%20%20description%3A%20Name%20of%20the%20tool%20being%20called.%0A-%20name%3A%20provider_info%0A%20%20type%3A%20object%0A%20%20description%3A%20Information%20about%20the%20tool%20provider.%20Discriminated%20union%20upon%20possible%20provider%20types.%0A%20%20children%3A%0A%20%20%20%20-%20name%3A%20Plugin%20provider%20info%0A%20%20%20%20%20%20type%3A%20object%0A%20%20%20%20%20%20description%3A%20Present%20when%20the%20tool%20is%20provided%20by%20a%20plugin.%0A%20%20%20%20%20%20children%3A%0A%20%20%20%20%20%20%20%20-%20name%3A%20type%0A%20%20%20%20%20%20%20%20%20%20type%3A%20'%22plugin%22'%0A%20%20%20%20%20%20%20%20%20%20description%3A%20Provider%20type.%0A%20%20%20%20%20%20%20%20-%20name%3A%20plugin_id%0A%20%20%20%20%20%20%20%20%20%20type%3A%20string%0A%20%20%20%20%20%20%20%20%20%20description%3A%20Identifier%20of%20the%20plugin.%0A%20%20%20%20-%20name%3A%20Ephemeral%20MCP%20provider%20info%0A%20%20%20%20%20%20type%3A%20object%0A%20%20%20%20%20%20description%3A%20Present%20when%20the%20tool%20is%20provided%20by%20a%20ephemeral%20MCP%20server.%0A%20%20%20%20%20%20children%3A%0A%20%20%20%20%20%20%20%20-%20name%3A%20type%0A%20%20%20%20%20%20%20%20%20%20type%3A%20'%22ephemeral_mcp%22'%0A%20%20%20%20%20%20%20%20%20%20description%3A%20Provider%20type.%0A%20%20%20%20%20%20%20%20-%20name%3A%20server_label%0A%20%20%20%20%20%20%20%20%20%20type%3A%20string%0A%20%20%20%20%20%20%20%20%20%20description%3A%20Label%20of%20the%20MCP%20server.%0A-%20name%3A%20type%0A%20%20type%3A%20'%22tool_call.start%22'%0A%20%20description%3A%20The%20type%20of%20the%20event.%20Always%20%60tool_call.start%60." />
  </DocsHStackLeft>
...
<DocsHStack>
  <DocsHStackLeft>
    ...
    <DocsParamsTable data="-%20name%3A%20tool%0A%20%20type%3A%20string%0A%20%20description%3A%20Name%20of%20the%20tool%20being%20called.%0A-%20name%3A%20arguments%0A%20%20type%3A%20object%0A%20%20description%3A%20Arguments%20passed%20to%20the%20tool.%20Can%20have%20any%20keys%2Fvalues%20depending%20on%20the%20tool%20definition.%0A-%20name%3A%20provider_info%0A%20%20type%3A%20object%0A%20%20description%3A%20Information%20about%20the%20tool%20provider.%20Discriminated%20union%20upon%20possible%20provider%20types.%0A%20%20children%3A%0A%20%20%20%20-%20name%3A%20Plugin%20provider%20info%0A%20%20%20%20%20%20type%3A%20object%0A%20%20%20%20%20%20description%3A%20Present%20when%20the%20tool%20is%20provided%20by%20a%20plugin.%0A%20%20%20%20%20%20children%3A%0A%20%20%20%20%20%20%20%20-%20name%3A%20type%0A%20%20%20%20%20%20%20%20%20%20type%3A%20'%22plugin%22'%0A%20%20%20%20%20%20%20%20%20%20description%3A%20Provider%20type.%0A%20%20%20%20%20%20%20%20-%20name%3A%20plugin_id%0A%20%20%20%20%20%20%20%20%20%20type%3A%20string%0A%20%20%20%20%20%20%20%20%20%20description%3A%20Identifier%20of%20the%20plugin.%0A%20%20%20%20-%20name%3A%20Ephemeral%20MCP%20provider%20info%0A%20%20%20%20%20%20type%3A%20object%0A%20%20%20%20%20%20description%3A%20Present%20when%20the%20tool%20is%20provided%20by%20a%20ephemeral%20MCP%20server.%0A%20%20%20%20%20%20children%3A%0A%20%20%20%20%20%20%20%20-%20name%3A%20type%0A%20%20%20%20%20%20%20%20%20%20type%3A%20'%22ephemeral_mcp%22'%0A%20%20%20%20%20%20%20%20%20%20description%3A%20Provider%20type.%0A%20%20%20%20%20%20%20%20-%20name%3A%20server_label%0A%20%20%20%20%20%20%20%20%20%20type%3A%20string%0A%20%20%20%20%20%20%20%20%20%20description%3A%20Label%20of%20the%20MCP%20server.%0A-%20name%3A%20type%0A%20%20type%3A%20'%22tool_call.arguments%22'%0A%20%20description%3A%20The%20type%20of%20the%20event.%20Always%20%60tool_call.arguments%60." />
  </DocsHStackLeft>
...
<DocsHStack>
  <DocsHStackLeft>
    ...
    <DocsParamsTable data="-%20name%3A%20tool%0A%20%20type%3A%20string%0A%20%20description%3A%20Name%20of%20the%20tool%20that%20was%20called.%0A-%20name%3A%20arguments%0A%20%20type%3A%20object%0A%20%20description%3A%20Arguments%20that%20were%20passed%20to%20the%20tool.%0A-%20name%3A%20output%0A%20%20type%3A%20string%0A%20%20description%3A%20Raw%20tool%20output%20string.%0A-%20name%3A%20provider_info%0A%20%20type%3A%20object%0A%20%20description%3A%20Information%20about%20the%20tool%20provider.%20Discriminated%20union%20upon%20possible%20provider%20types.%0A%20%20children%3A%0A%20%20%20%20-%20name%3A%20Plugin%20provider%20info%0A%20%20%20%20%20%20type%3A%20object%0A%20%20%20%20%20%20description%3A%20Present%20when%20the%20tool%20is%20provided%20by%20a%20plugin.%0A%20%20%20%20%20%20children%3A%0A%20%20%20%20%20%20%20%20-%20name%3A%20type%0A%20%20%20%20%20%20%20%20%20%20type%3A%20'%22plugin%22'%0A%20%20%20%20%20%20%20%20%20%20description%3A%20Provider%20type.%0A%20%20%20%20%20%20%20%20-%20name%3A%20plugin_id%0A%20%20%20%20%20%20%20%20%20%20type%3A%20string%0A%20%20%20%20%20%20%20%20%20%20description%3A%20Identifier%20of%20the%20plugin.%0A%20%20%20%20-%20name%3A%20Ephemeral%20MCP%20provider%20info%0A%20%20%20%20%20%20type%3A%20object%0A%20%20%20%20%20%20description%3A%20Present%20when%20the%20tool%20is%20provided%20by%20a%20ephemeral%20MCP%20server.%0A%20%20%20%20%20%20children%3A%0A%20%20%20%20%20%20%20%20-%20name%3A%20type%0A%20%20%20%20%20%20%20%20%20%20type%3A%20'%22ephemeral_mcp%22'%0A%20%20%20%20%20%20%20%20%20%20description%3A%20Provider%20type.%0A%20%20%20%20%20%20%20%20-%20name%3A%20server_label%0A%20%20%20%20%20%20%20%20%20%20type%3A%20string%0A%20%20%20%20%20%20%20%20%20%20description%3A%20Label%20of%20the%20MCP%20server.%0A-%20name%3A%20type%0A%20%20type%3A%20'%22tool_call.success%22'%0A%20%20description%3A%20The%20type%20of%20the%20event.%20Always%20%60tool_call.success%60." />
  </DocsHStackLeft>
...
<DocsHStack>
  <DocsHStackLeft>
    ...
    <DocsParamsTable data="-%20name%3A%20reason%0A%20%20type%3A%20string%0A%20%20description%3A%20Reason%20for%20the%20tool%20call%20failure.%0A-%20name%3A%20metadata%0A%20%20type%3A%20object%0A%20%20description%3A%20Metadata%20about%20the%20invalid%20tool%20call.%0A%20%20children%3A%0A%20%20%20%20-%20name%3A%20type%0A%20%20%20%20%20%20type%3A%20'%22invalid_name%22%20%7C%20%22invalid_arguments%22'%0A%20%20%20%20%20%20description%3A%20Type%20of%20error%20that%20occurred.%0A%20%20%20%20-%20name%3A%20tool_name%0A%20%20%20%20%20%20type%3A%20string%0A%20%20%20%20%20%20description%3A%20Name%20of%20the%20tool%20that%20was%20attempted%20to%20be%20called.%0A%20%20%20%20-%20name%3A%20arguments%0A%20%20%20%20%20%20type%3A%20object%0A%20%20%20%20%20%20optional%3A%20true%0A%20%20%20%20%20%20description%3A%20Arguments%20that%20were%20passed%20to%20the%20tool%20(only%20present%20for%20%60invalid_arguments%60%20errors).%0A%20%20%20%20-%20name%3A%20provider_info%0A%20%20%20%20%20%20type%3A%20object%0A%20%20%20%20%20%20optional%3A%20true%0A%20%20%20%20%20%20description%3A%20Information%20about%20the%20tool%20provider%20(only%20present%20for%20%60invalid_arguments%60%20errors).%0A%20%20%20%20%20%20children%3A%0A%20%20%20%20%20%20%20%20-%20name%3A%20type%0A%20%20%20%20%20%20%20%20%20%20type%3A%20'%22plugin%22%20%7C%20%22ephemeral_mcp%22'%0A%20%20%20%20%20%20%20%20%20%20description%3A%20Provider%20type.%0A%20%20%20%20%20%20%20%20-%20name%3A%20plugin_id%0A%20%20%20%20%20%20%20%20%20%20type%3A%20string%0A%20%20%20%20%20%20%20%20%20%20optional%3A%20true%0A%20%20%20%20%20%20%20%20%20%20description%3A%20Identifier%20of%20the%20plugin%20(when%20%60type%60%20is%20%60%22plugin%22%60).%0A%20%20%20%20%20%20%20%20-%20name%3A%20server_label%0A%20%20%20%20%20%20%20%20%20%20type%3A%20string%0A%20%20%20%20%20%20%20%20%20%20optional%3A%20true%0A%20%20%20%20%20%20%20%20%20%20description%3A%20Label%20of%20the%20MCP%20server%20(when%20%60type%60%20is%20%60%22ephemeral_mcp%22%60).%0A-%20name%3A%20type%0A%20%20type%3A%20'%22tool_call.failure%22'%0A%20%20description%3A%20The%20type%20of%20the%20event.%20Always%20%60tool_call.failure%60." />
  </DocsHStackLeft>
...
<DocsHStack>
  <DocsHStackLeft>
    ...
    <DocsParamsTable data="-%20name%3A%20type%0A%20%20type%3A%20'%22message.start%22'%0A%20%20description%3A%20The%20type%20of%20the%20event.%20Always%20%60message.start%60." />
  </DocsHStackLeft>
...
<DocsHStack>
  <DocsHStackLeft>
    ...
    <DocsParamsTable data="-%20name%3A%20content%0A%20%20type%3A%20string%0A%20%20description%3A%20Message%20text%20fragment.%0A-%20name%3A%20type%0A%20%20type%3A%20'%22message.delta%22'%0A%20%20description%3A%20The%20type%20of%20the%20event.%20Always%20%60message.delta%60." />
  </DocsHStackLeft>
...
<DocsHStack>
  <DocsHStackLeft>
    ...
    <DocsParamsTable data="-%20name%3A%20type%0A%20%20type%3A%20'%22message.end%22'%0A%20%20description%3A%20The%20type%20of%20the%20event.%20Always%20%60message.end%60." />
  </DocsHStackLeft>
...
<DocsHStack>
  <DocsHStackLeft>
    ...
    <DocsParamsTable data="-%20name%3A%20error%0A%20%20type%3A%20object%0A%20%20description%3A%20Error%20information.%0A%20%20children%3A%0A%20%20%20%20-%20name%3A%20type%0A%20%20%20%20%20%20type%3A%20'%22invalid_request%22%20%7C%20%22unknown%22%20%7C%20%22mcp_connection_error%22%20%7C%20%22plugin_connection_error%22%20%7C%20%22not_implemented%22%20%7C%20%22model_not_found%22%20%7C%20%22job_not_found%22%20%7C%20%22internal_error%22'%0A%20%20%20%20%20%20description%3A%20High-level%20error%20type.%0A%20%20%20%20-%20name%3A%20message%0A%20%20%20%20%20%20type%3A%20string%0A%20%20%20%20%20%20description%3A%20Human-readable%20error%20message.%0A%20%20%20%20-%20name%3A%20code%0A%20%20%20%20%20%20type%3A%20string%0A%20%20%20%20%20%20optional%3A%20true%0A%20%20%20%20%20%20description%3A%20More%20detailed%20error%20code%20(e.g.%2C%20validation%20issue%20code).%0A%20%20%20%20-%20name%3A%20param%0A%20%20%20%20%20%20type%3A%20string%0A%20%20%20%20%20%20optional%3A%20true%0A%20%20%20%20%20%20description%3A%20Parameter%20associated%20with%20the%20error%2C%20if%20applicable.%0A-%20name%3A%20type%0A%20%20type%3A%20'%22error%22'%0A%20%20description%3A%20The%20type%20of%20the%20event.%20Always%20%60error%60." />
  </DocsHStackLeft>
...
<DocsHStack>
  <DocsHStackLeft>
    ...
    <DocsParamsTable data="-%20name%3A%20result%0A%20%20type%3A%20object%0A%20%20description%3A%20Final%20response%20with%20%60model_instance_id%60%2C%20%60output%60%2C%20%60stats%60%2C%20and%20optional%20%60response_id%60.%20See%20%5Bnon-streaming%20chat%20docs%5D(%2Fdocs%2Fdeveloper%2Frest%2Fchat)%20for%20more%20details.%0A-%20name%3A%20type%0A%20%20type%3A%20'%22chat.end%22'%0A%20%20description%3A%20The%20type%20of%20the%20event.%20Always%20%60chat.end%60." />
  </DocsHStackLeft>
...
<DocsHStack>
  <DocsHStackLeft>
    ...
    **Request body**
    ...
    <DocsParamsTable data="-%20name%3A%20instance_id%0A%20%20type%3A%20string%0A%20%20optional%3A%20false%0A%20%20description%3A%20Unique%20identifier%20of%20the%20model%20instance%20to%20unload." />
  </DocsHStackLeft>
...
<DocsHStack>
  <DocsHStackLeft>
    **Response fields**
    ...
    <DocsParamsTable data="-%20name%3A%20instance_id%0A%20%20type%3A%20string%0A%20%20description%3A%20Unique%20identifier%20for%20the%20unloaded%20model%20instance." />
  </DocsHStackLeft>
...
* See OpenAI docs: [https://platform.openai.com/docs/api-reference/completions](https://platform.openai.com/docs/api-reference/completions)
...
<table className="flexible-cols">
  ...
  <tbody>
    <tr>
      ...
      <td>
        <a href="/docs/developer/openai-compat/models">Models</a>
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        <a href="/docs/developer/openai-compat/responses">Responses</a>
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        <a href="/docs/developer/openai-compat/chat-completions">Chat Completions</a>
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        <a href="/docs/developer/openai-compat/embeddings">Embeddings</a>
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        <a href="/docs/developer/openai-compat/completions">Completions</a>
      </td>
    </tr>
  </tbody>
</table>
...
Set the `base url` to point to LM Studio [#set-the-base-url-to-point-to-lm-studio]
...
Using Codex with LM Studio [#using-codex-with-lm-studio]
...
cURL (non‑streaming) [#curl-nonstreaming]
...
Stateful follow‑up [#stateful-followup]
...
Tools and Remote MCP (opt‑in) [#tools-and-remote-mcp-optin]
...
Install `lms` by running `npx lmstudio install-cli` [#install-lms-by-running-npx-lmstudio-install-cli]
...
1. You provide a list of tools to an LLM. These are the tools that the model can *request* calls to.
   For example:
...
<details>
  <summary>
    <code>multi-turn-example.py</code>
...
<details>
  <summary>
    <code>agent-chat-example.py</code>
...
<details>
  <summary>
    <code>tool-streaming-chatbot.py</code>
...
<table className="flexible-cols">
  ...
  <tbody>
    <tr>
      ...
      <td>
        <a href="/docs/developer/anthropic-compat/messages">Messages</a>
      </td>
    </tr>
  </tbody>
</table>

Using Claude Code with LM Studio [#using-claude-code-with-lm-studio]
...
Installing `lmstudio-python` [#installing-lmstudio-python]
...
<CodeBlockTabs defaultValue="pip">
  <CodeBlockTabsList>
    <CodeBlockTabsTrigger value="pip">
      pip
    </CodeBlockTabsTrigger>

    <CodeBlockTabsTrigger value="pdm">
      pdm
    </CodeBlockTabsTrigger>

    <CodeBlockTabsTrigger value="uv">
      uv
    </CodeBlockTabsTrigger>
  </CodeBlockTabsList>
...
Customizing the server API host and TCP port [#customizing-the-server-api-host-and-tcp-port]
...
<CodeBlockTabs defaultValue="Python (synchronous API)">
  <CodeBlockTabsList>
    <CodeBlockTabsTrigger value="Python (synchronous API)">
  ...
  <CodeBlockTab value="Python (synchronous API)">
    ```python
    import lmstudio as lms
    SERVER_API_HOST = "localhost:1234"
...
Example: Get an LLM to Simulate a Terminal [#example-get-an-llm-to-simulate-a-terminal]
...
<Steps>
  ...
  <Step>
    <h3>
      Pass the Image to the Model in 
...
Option 1: Input a Single String [#option-1-input-a-single-string]
...
Option 2: Using the `Chat` Helper Class [#option-2-using-the-chat-helper-class]
...
<CodeBlockTabs defaultValue="Chat history data">
  <CodeBlockTabsList>
    <CodeBlockTabsTrigger value="Chat history data">
      Chat history data
    </CodeBlockTabsTrigger>

    <CodeBlockTabsTrigger value="Single string">
      Single string
    </CodeBlockTabsTrigger>
  </CodeBlockTabsList>

  <CodeBlockTab value="Chat history data">
    ```python
  ...
  <CodeBlockTab value="Single string">
    ```python
...
Option 3: Providing Chat History Data Directly [#option-3-providing-chat-history-data-directly]
...
Automatic tool calling [#automatic-tool-calling]
...
<CodeBlockTabs defaultValue="Python function">
  <CodeBlockTabsList>
    <CodeBlockTabsTrigger value="Python function">
      Python function
    </CodeBlockTabsTrigger>

    <CodeBlockTabsTrigger value="ToolFunctionDef.from_callable">
      ToolFunctionDef.from_callable
    </CodeBlockTabsTrigger>

    <CodeBlockTabsTrigger value="ToolFunctionDef">
      ToolFunctionDef
    </CodeBlockTabsTrigger>
  </CodeBlockTabsList>

  <CodeBlockTab value="Python function">
    ```python
  ...
  <CodeBlockTab value="ToolFunctionDef.from_callable">
    ```python
  ...
  <CodeBlockTab value="ToolFunctionDef">
    ```python
    from lmstudio import ToolFunctionDef
...
Tools with External Effects (like Computer Use or API Calls) [#tools-with-external-effects-like-computer-use-or-api-calls]
...
Example: `create_file_tool` [#example-create_file_tool]
...
Example code using the `create_file` tool: [#example-code-using-the-create_file-tool]

```python title="hybridai.py"
import lmstudio as lms
...
Handling tool calling errors [#handling-tool-calling-errors]
...
Available Models on the LM Studio Server [#available-models-on-the-lm-studio-server]
...
List Models Currently Loaded in Memory [#list-models-currently-loaded-in-memory]
...
Get the Current Model with `.model()` [#get-the-current-model-with-model]
...
Get a Specific Model with `.model("model-key")` [#get-a-specific-model-with-modelmodel-key]

If you want to use a specific model, you can provide the model key as an argument to `.model()`.

Get if Loaded, or Load if not [#get-if-loaded-or-load-if-not]
...
Load a New Instance of a Model with `.load_new_instance()` [#load-a-new-instance-of-a-model-with-load_new_instance]
...
Unload a Model from Memory with `.unload()` [#unload-a-model-from-memory-with-unload]
...
Set Custom Load Config Parameters [#set-custom-load-config-parameters]
...
Set an Auto Unload Timer (TTL) [#set-an-auto-unload-timer-ttl]

You can specify a *time to live* for a model you load, which is the idle time (in seconds)
...
Use the `get_context_length()` function on the model object [#use-the-get_context_length-function-on-the-model-object]
...
<DocsParamsTable data="-%20name%3A%20%22--json%22%0A%20%20type%3A%20%22flag%22%0A%20%20optional%3A%20true%0A%20%20description%3A%20%22Output%20the%20status%20in%20JSON%20format%22" />
...
<DocsParamsTable data="-%20name%3A%20%22--json%22%0A%20%20type%3A%20%22flag%22%0A%20%20optional%3A%20true%0A%20%20description%3A%20%22Output%20the%20result%20in%20JSON%20format%22" />
...
<DocsParamsTable data="-%20name%3A%20%22--beta%22%0A%20%20type%3A%20%22flag%22%0A%20%20optional%3A%20true%0A%20%20description%3A%20%22Update%20to%20the%20latest%20beta%20release%22" />

Update the daemon [#update-the-daemon]
...
<DocsParamsTable data="-%20name%3A%20%22%5Bmodel%5D%22%0A%20%20type%3A%20%22string%22%0A%20%20optional%3A%20true%0A%20%20description%3A%20%22Identifier%20of%20the%20model%20to%20use.%20If%20omitted%2C%20you%20will%20be%20prompted%20to%20pick%20one.%22%0A-%20name%3A%20%22-p%2C%20--prompt%22%0A%20%20type%3A%20%22string%22%0A%20%20optional%3A%20true%0A%20%20description%3A%20%22Send%20a%20one-off%20prompt%20and%20print%20the%20response%20to%20stdout%20before%20exiting%22%0A-%20name%3A%20%22-s%2C%20--system-prompt%22%0A%20%20type%3A%20%22string%22%0A%20%20optional%3A%20true%0A%20%20description%3A%20%22Custom%20system%20prompt%20for%20the%20chat%22%0A-%20name%3A%20%22--stats%22%0A%20%20type%3A%20%22flag%22%0A%20%20optional%3A%20true%0A%20%20description%3A%20%22Show%20detailed%20prediction%20statistics%20after%20each%20response%22%0A-%20name%3A%20%22--ttl%22%0A%20%20type%3A%20%22number%22%0A%20%20optional%3A%20true%0A%20%20description%3A%20%22Seconds%20to%20keep%20the%20model%20loaded%20after%20the%20chat%20ends%20(default%3A%203600)%22" />
...
<DocsParamsTable data="-%20name%3A%20%22%5BmodelName%5D%22%0A%20%20type%3A%20%22string%22%0A%20%20optional%3A%20true%0A%20%20description%3A%20%22The%20model%20to%20download.%20If%20omitted%2C%20staff%20picks%20are%20shown.%20For%20models%20with%20multiple%20quantizations%2C%20append%20'%40'%20(e.g.%2C%20'llama-3.1-8b%40q4_k_m').%22%0A-%20name%3A%20%22--mlx%22%0A%20%20type%3A%20%22flag%22%0A%20%20optional%3A%20true%0A%20%20description%3A%20%22Include%20only%20MLX%20models%20in%20search%20results.%20If%20either%20'--mlx'%20or%20'--gguf'%20is%20set%2C%20only%20matching%20formats%20are%20shown%3B%20otherwise%20results%20match%20installed%20runtimes.%22%0A-%20name%3A%20%22--gguf%22%0A%20%20type%3A%20%22flag%22%0A%20%20optional%3A%20true%0A%20%20description%3A%20%22Include%20only%20GGUF%20models%20in%20search%20results.%20If%20either%20'--mlx'%20or%20'--gguf'%20is%20set%2C%20only%20matching%20formats%20are%20shown%3B%20otherwise%20results%20match%20installed%20runtimes.%22%0A-%20name%3A%20%22-n%2C%20--limit%22%0A%20%20type%3A%20%22number%22%0A%20%20optional%3A%20true%0A%20%20description%3A%20%22Limit%20the%20number%20of%20model%20options%20shown.%22%0A-%20name%3A%20%22--always-show-all-results%22%0A%20%20type%3A%20%22flag%22%0A%20%20optional%3A%20true%0A%20%20description%3A%20%22Always%20prompt%20you%20to%20choose%20from%20search%20results%2C%20even%20when%20there's%20an%20exact%20match.%22%0A-%20name%3A%20%22-a%2C%20--always-show-download-options%22%0A%20%20type%3A%20%22flag%22%0A%20%20optional%3A%20true%0A%20%20description%3A%20%22Always%20prompt%20you%20to%20choose%20a%20quantization%2C%20even%20when%20an%20exact%20match%20is%20auto-selected.%22" />
...
<DocsParamsTable data="-%20name%3A%20%22%3Cfile-path%3E%22%0A%20%20type%3A%20%22string%22%0A%20%20optional%3A%20false%0A%20%20description%3A%20%22Path%20to%20the%20model%20file%20to%20import%22%0A-%20name%3A%20%22--user-repo%22%0A%20%20type%3A%20%22string%22%0A%20%20optional%3A%20true%0A%20%20description%3A%20%22Set%20the%20target%20folder%20as%20%3Cuser%3E%2F%3Crepo%3E.%20Skips%20the%20categorization%20prompts.%22%0A-%20name%3A%20%22-y%2C%20--yes%22%0A%20%20type%3A%20%22flag%22%0A%20%20optional%3A%20true%0A%20%20description%3A%20%22Skip%20confirmations%20and%20try%20to%20infer%20the%20model%20location%20from%20the%20file%20name%22%0A-%20name%3A%20%22-c%2C%20--copy%22%0A%20%20type%3A%20%22flag%22%0A%20%20optional%3A%20true%0A%20%20description%3A%20%22Copy%20the%20file%20instead%20of%20moving%20it%22%0A-%20name%3A%20%22-L%2C%20--hard-link%22%0A%20%20type%3A%20%22flag%22%0A%20%20optional%3A%20true%0A%20%20description%3A%20%22Create%20a%20hard%20link%20instead%20of%20moving%20or%20copying%20the%20file%22%0A-%20name%3A%20%22-l%2C%20--symbolic-link%22%0A%20%20type%3A%20%22flag%22%0A%20%20optional%3A%20true%0A%20%20description%3A%20%22Create%20a%20symbolic%20link%20instead%20of%20moving%20or%20copying%20the%20file%22%0A-%20name%3A%20%22--dry-run%22%0A%20%20type%3A%20%22flag%22%0A%20%20optional%3A%20true%0A%20%20description%3A%20%22Do%20not%20perform%20the%20import%2C%20just%20show%20what%20would%20be%20done%22" />
...
<DocsParamsTable data="-%20name%3A%20%22%5Bpath%5D%22%0A%20%20type%3A%20%22string%22%0A%20%20optional%3A%20true%0A%20%20description%3A%20%22The%20path%20of%20the%20model%20to%20load.%20If%20not%20provided%2C%20you%20will%20be%20prompted%20to%20select%20one%22%0A-%20name%3A%20%22--ttl%22%0A%20%20type%3A%20%22number%22%0A%20%20optional%3A%20true%0A%20%20description%3A%20%22If%20provided%2C%20when%20the%20model%20is%20not%20used%20for%20this%20number%20of%20seconds%2C%20it%20will%20be%20unloaded%22%0A-%20name%3A%20%22--gpu%22%0A%20%20type%3A%20%22string%22%0A%20%20optional%3A%20true%0A%20%20description%3A%20%22How%20much%20to%20offload%20to%20the%20GPU.%20Values%3A%200-1%2C%20off%2C%20max%22%0A-%20name%3A%20%22--context-length%22%0A%20%20type%3A%20%22number%22%0A%20%20optional%3A%20true%0A%20%20description%3A%20%22The%20number%20of%20tokens%20to%20consider%20as%20context%20when%20generating%20text%22%0A-%20name%3A%20%22--identifier%22%0A%20%20type%3A%20%22string%22%0A%20%20optional%3A%20true%0A%20%20description%3A%20%22The%20identifier%20to%20assign%20to%20the%20loaded%20model%20for%20API%20reference%22%0A-%20name%3A%20%22--estimate-only%22%0A%20%20type%3A%20%22boolean%22%0A%20%20optional%3A%20true%0A%20%20description%3A%20%22Print%20a%20resource%20(memory)%20estimate%20and%20exit%20without%20loading%20the%20model%22" />
...
<DocsParamsTable data="-%20name%3A%20%22%5Bmodel_key%5D%22%0A%20%20type%3A%20%22string%22%0A%20%20optional%3A%20true%0A%20%20description%3A%20%22The%20key%20of%20the%20model%20to%20unload.%20If%20not%20provided%2C%20you%20will%20be%20prompted%20to%20select%20one%22%0A-%20name%3A%20%22--all%22%0A%20%20type%3A%20%22flag%22%0A%20%20optional%3A%20true%0A%20%20description%3A%20%22Unload%20all%20currently%20loaded%20models%22%0A-%20name%3A%20%22--host%22%0A%20%20type%3A%20%22string%22%0A%20%20optional%3A%20true%0A%20%20description%3A%20%22The%20host%20address%20of%20a%20remote%20LM%20Studio%20instance%20to%20connect%20to%22" />
...
Operate on a remote LM Studio instance [#operate-on-a-remote-lm-studio-instance]
...
<DocsParamsTable data="-%20name%3A%20%22--llm%22%0A%20%20type%3A%20%22flag%22%0A%20%20optional%3A%20true%0A%20%20description%3A%20%22Show%20only%20LLMs.%20When%20not%20set%2C%20all%20models%20are%20shown%22%0A-%20name%3A%20%22--embedding%22%0A%20%20type%3A%20%22flag%22%0A%20%20optional%3A%20true%0A%20%20description%3A%20%22Show%20only%20embedding%20models%22%0A-%20name%3A%20%22--json%22%0A%20%20type%3A%20%22flag%22%0A%20%20optional%3A%20true%0A%20%20description%3A%20%22Output%20the%20list%20in%20JSON%20format%22%0A-%20name%3A%20%22--detailed%22%0A%20%20type%3A%20%22flag%22%0A%20%20optional%3A%20true%0A%20%20description%3A%20%22Show%20detailed%20information%20about%20each%20model%22" />
...
Download a runtime [#download-a-runtime]

```shell
lms runtime get
```

Switch to a runtime [#switch-to-a-runtime]
...
<DocsParamsTable data="-%20name%3A%20%22-s%2C%20--source%22%0A%20%20type%3A%20%22string%22%0A%20%20optional%3A%20true%0A%20%20description%3A%20%22Source%20of%20logs%3A%20model%20or%20server%20(default%3A%20model)%22%0A-%20name%3A%20%22--stats%22%0A%20%20type%3A%20%22flag%22%0A%20%20optional%3A%20true%0A%20%20description%3A%20%22Print%20prediction%20stats%20when%20available%22%0A-%20name%3A%20%22--filter%22%0A%20%20type%3A%20%22string%22%0A%20%20optional%3A%20true%0A%20%20description%3A%20%22Filter%20for%20model%20source%3A%20input%2C%20output%2C%20or%20both%22%0A-%20name%3A%20%22--json%22%0A%20%20type%3A%20%22flag%22%0A%20%20optional%3A%20true%0A%20%20description%3A%20%22Output%20logs%20as%20JSON%20(newline%20separated)%22" />
...
<DocsParamsTable data="-%20name%3A%20%22--port%22%0A%20%20type%3A%20%22number%22%0A%20%20optional%3A%20true%0A%20%20description%3A%20%22Port%20to%20run%20the%20server%20on.%20If%20not%20provided%2C%20uses%20the%20last%20used%20port%22%0A-%20name%3A%20%22--cors%22%0A%20%20type%3A%20%22flag%22%0A%20%20optional%3A%20true%0A%20%20description%3A%20%22Enable%20CORS%20support%20for%20web%20application%20development.%20When%20not%20set%2C%20CORS%20is%20disabled%22" />
...
<DocsParamsTable data="-%20name%3A%20%22--json%22%0A%20%20type%3A%20%22flag%22%0A%20%20optional%3A%20true%0A%20%20description%3A%20%22Output%20the%20status%20in%20JSON%20format%22%0A-%20name%3A%20%22--verbose%22%0A%20%20type%3A%20%22flag%22%0A%20%20optional%3A%20true%0A%20%20description%3A%20%22Enable%20detailed%20logging%20output%22%0A-%20name%3A%20%22--quiet%22%0A%20%20type%3A%20%22flag%22%0A%20%20optional%3A%20true%0A%20%20description%3A%20%22Suppress%20all%20logging%20output%22%0A-%20name%3A%20%22--log-level%22%0A%20%20type%3A%20%22string%22%0A%20%20optional%3A%20true%0A%20%20description%3A%20%22The%20level%20of%20logging%20to%20use.%20Defaults%20to%20'info'%22" />
...
<DocsParamsTable data="-%20name%3A%20%22%3Cartifact%3E%22%0A%20%20type%3A%20%22string%22%0A%20%20optional%3A%20false%0A%20%20description%3A%20%22Artifact%20identifier%20in%20the%20form%20owner%2Fname%22%0A-%20name%3A%20%22%5Bpath%5D%22%0A%20%20type%3A%20%22string%22%0A%20%20optional%3A%20true%0A%20%20description%3A%20%22Destination%20folder.%20Defaults%20to%20a%20new%20folder%20named%20after%20the%20artifact.%22" />
...
<DocsParamsTable data="-%20name%3A%20%22-i%2C%20--install%22%0A%20%20type%3A%20%22flag%22%0A%20%20optional%3A%20true%0A%20%20description%3A%20%22Install%20the%20plugin%20into%20LM%20Studio%20instead%20of%20running%20the%20dev%20server%22%0A-%20name%3A%20%22--no-notify%22%0A%20%20type%3A%20%22flag%22%0A%20%20optional%3A%20true%0A%20%20description%3A%20%22Do%20not%20show%20the%20%5C%22Plugin%20started%5C%22%20notification%20in%20LM%20Studio%22" />
...
<DocsParamsTable data="-%20name%3A%20%22--with-pre-authenticated-keys%22%0A%20%20type%3A%20%22flag%22%0A%20%20optional%3A%20true%0A%20%20description%3A%20%22Authenticate%20using%20pre-generated%20keys%20(CI%2FCD).%20Requires%20--key-id%2C%20--public-key%2C%20and%20--private-key.%22%0A-%20name%3A%20%22--key-id%22%0A%20%20type%3A%20%22string%22%0A%20%20optional%3A%20true%0A%20%20description%3A%20%22Key%20ID%20to%20use%20with%20--with-pre-authenticated-keys%22%0A-%20name%3A%20%22--public-key%22%0A%20%20type%3A%20%22string%22%0A%20%20optional%3A%20true%0A%20%20description%3A%20%22Public%20key%20to%20use%20with%20--with-pre-authenticated-keys%22%0A-%20name%3A%20%22--private-key%22%0A%20%20type%3A%20%22string%22%0A%20%20optional%3A%20true%0A%20%20description%3A%20%22Private%20key%20to%20use%20with%20--with-pre-authenticated-keys%22" />
...
<DocsParamsTable data="-%20name%3A%20%22--description%22%0A%20%20type%3A%20%22string%22%0A%20%20optional%3A%20true%0A%20%20description%3A%20%22Override%20the%20artifact%20description%20for%20this%20push%22%0A-%20name%3A%20%22--overrides%22%0A%20%20type%3A%20%22string%22%0A%20%20optional%3A%20true%0A%20%20description%3A%20%22JSON%20string%20to%20override%20manifest%20fields%20(parsed%20with%20JSON.parse)%22%0A-%20name%3A%20%22-y%2C%20--yes%22%0A%20%20type%3A%20%22flag%22%0A%20%20optional%3A%20true%0A%20%20description%3A%20%22Suppress%20confirmations%20and%20warnings%22%0A-%20name%3A%20%22--private%22%0A%20%20type%3A%20%22flag%22%0A%20%20optional%3A%20true%0A%20%20description%3A%20%22Mark%20the%20artifact%20as%20private%20when%20first%20published%22%0A-%20name%3A%20%22--write-revision%22%0A%20%20type%3A%20%22flag%22%0A%20%20optional%3A%20true%0A%20%20description%3A%20%22Write%20the%20returned%20revision%20number%20to%20manifest.json%22" />

Advanced [#advanced]

Publish quietly and keep the revision in manifest.json [#publish-quietly-and-keep-the-revision-in-manifestjson]

```shell
lms push -y --write-revision
```

Override metadata for this upload [#override-metadata-for-this-upload]
...
<img src="/assets/marketing/docs/mcp-auth.webp" style="width: 100%;" data-caption="Atlassian MCP logged in and Notion MCP requiring authentication" />
...
<div className="w-fit">
  <a style="{ background: &#x22;rgb(255,255,255)&#x22; }" href="https://lmstudio.ai/install-mcp?name=linear&config=eyJ1cmwiOiJodHRwczovL21jcC5saW5lYXIuYXBwL21jcCJ9">
    <img src="https://files.lmstudio.ai/deeplink/mcp-install-light.svg" alt="Add Linear MCP to LM Studio" className="dark:hidden" />

    <img src="https://files.lmstudio.ai/deeplink/mcp-install-dark.svg" alt="Add Linear MCP to LM Studio" className="hidden dark:block" />
  </a>
</div>
...
<div className="w-fit">
  <a style="{ background: &#x22;rgb(255,255,255)&#x22; }" href="https://lmstudio.ai/install-mcp?name=notion&config=eyJ1cmwiOiJodHRwczovL21jcC5ub3Rpb24uY29tL21jcCJ9">
    <img src="https://files.lmstudio.ai/deeplink/mcp-install-light.svg" alt="Add Notion MCP to LM Studio" className="dark:hidden" />

    <img src="https://files.lmstudio.ai/deeplink/mcp-install-dark.svg" alt="Add Notion MCP to LM Studio" className="hidden dark:block" />
  </a>
</div>
...
<div className="w-fit">
  <a style="{ background: &#x22;rgb(255,255,255)&#x22; }" href="https://lmstudio.ai/install-mcp?name=atlassian&config=eyJ1cmwiOiJodHRwczovL21jcC5hdGxhc3NpYW4uY29tL3YxL21jcCJ9">
    <img src="https://files.lmstudio.ai/deeplink/mcp-install-light.svg" alt="Add Atlassian MCP to LM Studio" className="dark:hidden" />

    <img src="https://files.lmstudio.ai/deeplink/mcp-install-dark.svg" alt="Add Atlassian MCP to LM Studio" className="hidden dark:block" />
  </a>
</div>
...
<div className="w-fit">
  <a style="{ background: &#x22;rgb(255,255,255)&#x22; }" href="https://lmstudio.ai/install-mcp?name=sentry&config=eyJ1cmwiOiJodHRwczovL21jcC5zZW50cnkuZGV2L21jcCJ9">
    <img src="https://files.lmstudio.ai/deeplink/mcp-install-light.svg" alt="Add Sentry MCP to LM Studio" className="dark:hidden" />

    <img src="https://files.lmstudio.ai/deeplink/mcp-install-dark.svg" alt="Add Sentry MCP to LM Studio" className="hidden dark:block" />
  </a>
</div>
...
<img src="/assets/marketing/docs/lmlink-adddevice.png" style="" data-caption="Add Device modal in LM Link" />
...
<img src="/assets/marketing/docs/lmlink-useremotemodels.png" style="" data-caption="Load models on remote devices with LM Link" />
...
Q: Why does a device show up as “disconnected”? [#q-why-does-a-device-show-up-as-disconnected]
...
```html
<img src="/assets/marketing/docs/lmlink-sidebar.gif"/>
```
...
<CodeBlockTabs defaultValue="Using an array of messages">
  <CodeBlockTabsList>
    <CodeBlockTabsTrigger value="Using an array of messages">
      Using an array of messages
    </CodeBlockTabsTrigger>

    <CodeBlockTabsTrigger value="Constructing a Chat object">
      Constructing a Chat object
    </CodeBlockTabsTrigger>
  </CodeBlockTabsList>

  <CodeBlockTab value="Using an array of messages">
```typescript
  ...
  <CodeBlockTab value="Constructing a Chat object">
    ```typescript
...
<CodeBlockTabs defaultValue="Streaming">
  <CodeBlockTabsList>
    <CodeBlockTabsTrigger value="Streaming">
      Streaming
    </CodeBlockTabsTrigger>
...
Use the `client.files.prepareImage()` method to get a handle to the image that can be subsequently passed to the model.
  ...
  ```typescript
    const imagePath = "/assets/image/image.jpg"; // Replace with the path to your image
...
Enforce Using a `zod` Schema [#enforce-using-a-zod-schema]
...
Define a `zod` Schema [#define-a-zod-schema]
...
Option 1: Array of Messages [#option-1-array-of-messages]

You can use an array of messages to represent a chat. Here is an example with the `.respond()` method.

<CodeBlockTabs defaultValue="Text-only">
  <CodeBlockTabsList>
    <CodeBlockTabsTrigger value="Text-only">
      Text-only
    </CodeBlockTabsTrigger>

    <CodeBlockTabsTrigger value="With Images">
      With Images
    </CodeBlockTabsTrigger>
  </CodeBlockTabsList>

  <CodeBlockTab value="Text-only">
    ```typescript
    const prediction = model.respond([
      { role: "system", content: "You are a resident AI philosopher." },
      { role: "user", content: "What is the meaning of life?" },
  ...
  <CodeBlockTab value="With Images">
    ```typescript
...
Option 2: Input a Single String [#option-2-input-a-single-string]
...
Option 3: Using the `Chat` Helper Class [#option-3-using-the-chat-helper-class]
...
<CodeBlockTabs defaultValue="Array of messages">
  <CodeBlockTabsList>
    <CodeBlockTabsTrigger value="Array of messages">
      Array of messages
    </CodeBlockTabsTrigger>
  ...
  <CodeBlockTab value="Array of messages">
    ```typescript
    const chat = Chat.from([
      { role: "system", content: "You are a resident AI philosopher." },
      { role: "user", content: "What is the meaning of life?" },
...
Example: `createFileTool` [#example-createfiletool]
...
Add dependencies to your plugin with `npm` [#add-dependencies-to-your-plugin-with-npm]
...
Available Model on the Local Machine [#available-model-on-the-local-machine]
...
Load a New Instance of a Model with `.load()` [#load-a-new-instance-of-a-model-with-load]
...
<CodeBlockTabs defaultValue="Using .load">
  <CodeBlockTabsList>
    <CodeBlockTabsTrigger value="Using .load">
      Using .load
    </CodeBlockTabsTrigger>

    <CodeBlockTabsTrigger value="Using .model">
      Using .model
    </CodeBlockTabsTrigger>
  </CodeBlockTabsList>

  <CodeBlockTab value="Using .load">
    ```typescript
    import { LMStudioClient } from "@lmstudio/sdk";
  ...
  <CodeBlockTab value="Using .model">
    ```typescript
    import { LMStudioClient } from "@lmstudio/sdk";
...
Parameters [#parameters](<DocsParamsTable data="-%20name%3A%20gpu%0A%20%20description%3A%20%7C%0A%20%20%20%20How%20to%20distribute%20the%20work%20to%20your%20GPUs.%20See%20%7B%40link%20GPUSetting%7D%20for%20more%20information.%0A%20%20public%3A%20true%0A%20%20type%3A%20GPUSetting%0A%20%20optional%3A%20true%0A%0A-%20name%3A%20contextLength%0A%20%20description%3A%20%7C%0A%20%20%20%20The%20size%20of%20the%20context%20length%20in%20number%20of%20tokens.%20This%20will%20include%20both%20the%20prompts%20and%20the%0A%20%20%20%20responses.%20Once%20the%20context%20length%20is%20exceeded%2C%20the%20value%20set%20in%0A%20%20%20%20%7B%40link%20LLMPredictionConfigBase%23contextOverflowPolicy%7D%20is%20used%20to%20determine%20the%20behavior.%0A%0A%20%20%20%20See%20%7B%40link%20LLMContextOverflowPolicy%7D%20for%20more%20information.%0A%20%20type%3A%20number%0A%20%20optional%3A%20true%0A%0A-%20name%3A%20ropeFrequencyBase%0A%20%20description%3A%20%7C%0A%20%20%20%20Custom%20base%20frequency%20for%20rotary%20positional%20embeddings%20(RoPE).%0A%0A%20%20%20%20This%20advanced%20parameter%20adjusts%20how%20positional%20information%20is%20embedded%20in%20the%20model's%0A%20%20%20%20representations.%20Increasing%20this%20value%20may%20enable%20better%20performance%20at%20high%20context%20lengths%20by%0A%20%20%20%20modifying%20how%20the%20model%20processes%20position-dependent%20information.%0A%20%20type%3A%20number%0A%20%20optional%3A%20true%0A%0A-%20name%3A%20ropeFrequencyScale%0A%20%20description%3A%20%7C%0A%20%20%20%20Scaling%20factor%20for%20RoPE%20(Rotary%20Positional%20Encoding)%20frequency.%0A%0A%20%20%20%20This%20factor%20scales%20the%20effective%20context%20window%20by%20modifying%20how%20positional%20information%20is%0A%20%20%20%20encoded.%20Higher%20values%20allow%20the%20model%20to%20handle%20longer%20contexts%20by%20making%20positional%20encoding%0A%20%20%20%20more%20granular%2C%20which%20can%20be%20particularly%20useful%20for%20extending%20a%20model%20beyond%20its%20original%0A%20%20%20%20training%20context%20length.%0A%20%20type%3A%20number%0A%20%20optional%3A%20true%0A%0A-%20name%3A%20evalBatchSize%0A%20%20description%3A%20%7C%0A%20%20%20%20Number%20of%20input%20tokens%20to%20process%20together%20in%20a%20single%20batch%20during%20evaluation.%0A%0A%20%20%20%20Increasing%20this%20value%20typically%20improves%20processing%20speed%20and%20throughput%20by%20leveraging%0A%20%20%20%20parallelization%2C%20but%20requires%20more%20memory.%20Finding%20the%20optimal%20batch%20size%20often%20involves%0A%20%20%20%20balancing%20between%20performance%20gains%20and%20available%20hardware%20resources.%0A%20%20type%3A%20number%0A%20%20optional%3A%20true%0A%0A-%20name%3A%20flashAttention%0A%20%20description%3A%20%7C%0A%20%20%20%20Enables%20Flash%20Attention%20for%20optimized%20attention%20computation.%0A%0A%20%20%20%20Flash%20Attention%20is%20an%20efficient%20implementation%20that%20reduces%20memory%20usage%20and%20speeds%20up%0A%20%20%20%20generation%20by%20optimizing%20how%20attention%20mechanisms%20are%20computed.%20This%20can%20significantly%0A%20%20%20%20improve%20performance%20on%20compatible%20hardware%2C%20especially%20for%20longer%20sequences.%0A%20%20type%3A%20boolean%0A%20%20optional%3A%20true%0A%0A-%20name%3A%20keepModelInMemory%0A%20%20description%3A%20%7C%0A%20%20%20%20When%20enabled%2C%20prevents%20the%20model%20from%20being%20swapped%20out%20of%20system%20memory.%0A%0A%20%20%20%20This%20option%20reserves%20system%20memory%20for%20the%20model%20even%20when%20portions%20are%20offloaded%20to%20GPU%2C%0A%20%20%20%20ensuring%20faster%20access%20times%20when%20the%20model%20needs%20to%20be%20used.%20Improves%20performance%0A%20%20%20%20particularly%20for%20interactive%20applications%2C%20but%20increases%20overall%20RAM%20requirements.%0A%20%20type%3A%20boolean%0A%20%20optional%3A%20true%0A%0A-%20name%3A%20seed%0A%20%20description%3A%20%7C%0A%20%20%20%20Random%20seed%20value%20for%20model%20initialization%20to%20ensure%20reproducible%20outputs.%0A%0A%20%20%20%20Setting%20a%20specific%20seed%20ensures%20that%20random%20operations%20within%20the%20model%20(like%20sampling)%0A%20%20%20%20produce%20the%20same%20results%20across%20different%20runs%2C%20which%20is%20important%20for%20reproducibility%0A%20%20%20%20in%20testing%20and%20development%20scenarios.%0A%20%20type%3A%20number%0A%20%20optional%3A%20true%0A%0A-%20name%3A%20useFp16ForKVCache%0A%20%20description%3A%20%7C%0A%20%20%20%20When%20enabled%2C%20stores%20the%20key-value%20cache%20in%20half-precision%20(FP16)%20format.%0A%0A%20%20%20%20This%20option%20significantly%20reduces%20memory%20usage%20during%20inference%20by%20using%2016-bit%20floating%0A%20%20%20%20point%20numbers%20instead%20of%2032-bit%20for%20the%20attention%20cache.%20While%20this%20may%20slightly%20reduce%0A%20%20%20%20numerical%20precision%2C%20the%20impact%20on%20output%20quality%20is%20generally%20minimal%20for%20most%20applications.%0A%20%20type%3A%20boolean%0A%20%20optional%3A%20true%0A%0A-%20name%3A%20tryMmap%0A%20%20description%3A%20%7C%0A%20%20%20%20Attempts%20to%20use%20memory-mapped%20(mmap)%20file%20access%20when%20loading%20the%20model.%0A%0A%20%20%20%20Memory%20mapping%20can%20improve%20initial%20load%20times%20by%20mapping%20model%20files%20directly%20from%20disk%20to%0A%20%20%20%20memory%2C%20allowing%20the%20operating%20system%20to%20handle%20paging.%20This%20is%20particularly%20beneficial%20for%0A%20%20%20%20quick%20startup%2C%20but%20may%20reduce%20performance%20if%20the%20model%20is%20larger%20than%20available%20system%20RAM%2C%0A%20%20%20%20causing%20frequent%20disk%20access.%0A%20%20type%3A%20boolean%0A%20%20optional%3A%20true%0A%0A-%20name%3A%20numExperts%0A%20%20description%3A%20%7C%0A%20%20%20%20Specifies%20the%20number%20of%20experts%20to%20use%20for%20models%20with%20Mixture%20of%20Experts%20(MoE)%20architecture.%0A%0A%20%20%20%20MoE%20models%20contain%20multiple%20%22expert%22%20networks%20that%20specialize%20in%20different%20aspects%20of%20the%20task.%0A%20%20%20%20This%20parameter%20controls%20how%20many%20of%20these%20experts%20are%20active%20during%20inference%2C%20affecting%20both%0A%20%20%20%20performance%20and%20quality%20of%20outputs.%20Only%20applicable%20for%20models%20designed%20with%20the%20MoE%20architecture.%0A%20%20type%3A%20number%0A%20%20optional%3A%20true%0A%0A-%20name%3A%20llamaKCacheQuantizationType%0A%20%20description%3A%20%7C%0A%20%20%20%20Quantization%20type%20for%20the%20Llama%20model's%20key%20cache.%0A%0A%20%20%20%20This%20option%20determines%20the%20precision%20level%20used%20to%20store%20the%20key%20component%20of%20the%20attention%0A%20%20%20%20mechanism's%20cache.%20Lower%20precision%20values%20(e.g.%2C%204-bit%20or%208-bit%20quantization)%20significantly%0A%20%20%20%20reduce%20memory%20usage%20during%20inference%20but%20may%20slightly%20impact%20output%20quality.%20The%20effect%20varies%0A%20%20%20%20between%20different%20models%2C%20with%20some%20being%20more%20robust%20to%20quantization%20than%20others.%0A%0A%20%20%20%20Set%20to%20false%20to%20disable%20quantization%20and%20use%20full%20precision.%0A%20%20type%3A%20LLMLlamaCacheQuantizationType%20%7C%20false%0A%20%20optional%3A%20true%0A%0A-%20name%3A%20llamaVCacheQuantizationType%0A%20%20description%3A%20%7C%0A%20%20%20%20Quantization%20type%20for%20the%20Llama%20model's%20value%20cache.%0A%0A%20%20%20%20Similar%20to%20the%20key%20cache%20quantization%2C%20this%20option%20controls%20the%20precision%20used%20for%20the%20value%0A%20%20%20%20component%20of%20the%20attention%20mechanism's%20cache.%20Reducing%20precision%20saves%20memory%20but%20may%20affect%0A%20%20%20%20generation%20quality.%20This%20option%20requires%20Flash%20Attention%20to%20be%20enabled%20to%20function%20properly.%0A%0A%20%20%20%20Different%20models%20respond%20differently%20to%20value%20cache%20quantization%2C%20so%20experimentation%20may%20be%0A%20%20%20%20needed%20to%20find%20the%20optimal%20setting%20for%20a%20specific%20use%20case.%20Set%20to%20false%20to%20disable%20quantization.%0A%20%20type%3A%20LLMLlamaCacheQuantizationType%20%7C%20false%0A%20%20optional%3A%20true" />)




Fields [#fields](<DocsParamsTable data="-%20name%3A%20%22maxTokens%22%0A%20%20type%3A%20%22number%20%7C%20false%22%0A%20%20optional%3A%20true%0A%20%20description%3A%20%22Number%20of%20tokens%20to%20predict%20at%20most.%20If%20set%20to%20false%2C%20the%20model%20will%20predict%20as%20many%20tokens%20as%20it%20wants.%5Cn%5CnWhen%20the%20prediction%20is%20stopped%20because%20of%20this%20limit%2C%20the%20%60stopReason%60%20in%20the%20prediction%20stats%20will%20be%20set%20to%20%60maxPredictedTokensReached%60.%22%0A%0A-%20name%3A%20%22temperature%22%0A%20%20type%3A%20%22number%22%0A%20%20optional%3A%20true%0A%20%20description%3A%20%22The%20temperature%20parameter%20for%20the%20prediction%20model.%20A%20higher%20value%20makes%20the%20predictions%20more%20random%2C%20while%20a%20lower%20value%20makes%20the%20predictions%20more%20deterministic.%20The%20value%20should%20be%20between%200%20and%201.%22%0A%0A-%20name%3A%20%22stopStrings%22%0A%20%20type%3A%20%22Array%3Cstring%3E%22%0A%20%20optional%3A%20true%0A%20%20description%3A%20%22An%20array%20of%20strings.%20If%20the%20model%20generates%20one%20of%20these%20strings%2C%20the%20prediction%20will%20stop.%5Cn%5CnWhen%20the%20prediction%20is%20stopped%20because%20of%20this%20limit%2C%20the%20%60stopReason%60%20in%20the%20prediction%20stats%20will%20be%20set%20to%20%60stopStringFound%60.%22%0A%0A-%20name%3A%20%22toolCallStopStrings%22%0A%20%20type%3A%20%22Array%3Cstring%3E%22%0A%20%20optional%3A%20true%0A%20%20description%3A%20%22An%20array%20of%20strings.%20If%20the%20model%20generates%20one%20of%20these%20strings%2C%20the%20prediction%20will%20stop%20with%20the%20%60stopReason%60%20%60toolCalls%60.%22%0A%0A-%20name%3A%20%22contextOverflowPolicy%22%0A%20%20type%3A%20%22LLMContextOverflowPolicy%22%0A%20%20optional%3A%20true%0A%20%20description%3A%20%22The%20behavior%20for%20when%20the%20generated%20tokens%20length%20exceeds%20the%20context%20window%20size.%20The%20allowed%20values%20are%3A%5Cn%5Cn-%20%60stopAtLimit%60%3A%20Stop%20the%20prediction%20when%20the%20generated%20tokens%20length%20exceeds%20the%20context%20window%20size.%20If%20the%20generation%20is%20stopped%20because%20of%20this%20limit%2C%20the%20%60stopReason%60%20in%20the%20prediction%20stats%20will%20be%20set%20to%20%60contextLengthReached%60%5Cn-%20%60truncateMiddle%60%3A%20Keep%20the%20system%20prompt%20and%20the%20first%20user%20message%2C%20truncate%20middle.%5Cn-%20%60rollingWindow%60%3A%20Maintain%20a%20rolling%20window%20and%20truncate%20past%20messages.%22%0A%0A-%20name%3A%20%22structured%22%0A%20%20type%3A%20%22ZodType%3CTStructuredOutputType%3E%20%7C%20LLMStructuredPredictionSetting%22%0A%20%20optional%3A%20true%0A%20%20description%3A%20%22Configures%20the%20model%20to%20output%20structured%20JSON%20data%20that%20follows%20a%20specific%20schema%20defined%20using%20Zod.%5Cn%5CnWhen%20you%20provide%20a%20Zod%20schema%2C%20the%20model%20will%20be%20instructed%20to%20generate%20JSON%20that%20conforms%20to%20that%20schema%20rather%20than%20free-form%20text.%5Cn%5CnThis%20is%20particularly%20useful%20for%20extracting%20specific%20data%20points%20from%20model%20responses%20or%20when%20you%20need%20the%20output%20in%20a%20format%20that%20can%20be%20directly%20used%20by%20your%20application.%22%0A%0A-%20name%3A%20%22topKSampling%22%0A%20%20type%3A%20%22number%22%0A%20%20optional%3A%20true%0A%20%20description%3A%20%22Controls%20token%20sampling%20diversity%20by%20limiting%20consideration%20to%20the%20K%20most%20likely%20next%20tokens.%5Cn%5CnFor%20example%2C%20if%20set%20to%2040%2C%20only%20the%2040%20tokens%20with%20the%20highest%20probabilities%20will%20be%20considered%20for%20the%20next%20token%20selection.%20A%20lower%20value%20(e.g.%2C%2020)%20will%20make%20the%20output%20more%20focused%20and%20conservative%2C%20while%20a%20higher%20value%20(e.g.%2C%20100)%20allows%20for%20more%20creative%20and%20diverse%20outputs.%5Cn%5CnTypical%20values%20range%20from%2020%20to%20100.%22%0A%0A-%20name%3A%20%22repeatPenalty%22%0A%20%20type%3A%20%22number%20%7C%20false%22%0A%20%20optional%3A%20true%0A%20%20description%3A%20%22Applies%20a%20penalty%20to%20repeated%20tokens%20to%20prevent%20the%20model%20from%20getting%20stuck%20in%20repetitive%20patterns.%5Cn%5CnA%20value%20of%201.0%20means%20no%20penalty.%20Values%20greater%20than%201.0%20increase%20the%20penalty.%20For%20example%2C%201.2%20would%20reduce%20the%20probability%20of%20previously%20used%20tokens%20by%2020%25.%20This%20is%20particularly%20useful%20for%20preventing%20the%20model%20from%20repeating%20phrases%20or%20getting%20stuck%20in%20loops.%5Cn%5CnSet%20to%20false%20to%20disable%20the%20penalty%20completely.%22%0A%0A-%20name%3A%20%22minPSampling%22%0A%20%20type%3A%20%22number%20%7C%20false%22%0A%20%20optional%3A%20true%0A%20%20description%3A%20%22Sets%20a%20minimum%20probability%20threshold%20that%20a%20token%20must%20meet%20to%20be%20considered%20for%20generation.%5Cn%5CnFor%20example%2C%20if%20set%20to%200.05%2C%20any%20token%20with%20less%20than%205%25%20probability%20will%20be%20excluded%20from%20consideration.%20This%20helps%20filter%20out%20unlikely%20or%20irrelevant%20tokens%2C%20potentially%20improving%20output%20quality.%5Cn%5CnValue%20should%20be%20between%200%20and%201.%20Set%20to%20false%20to%20disable%20this%20filter.%22%0A%0A-%20name%3A%20%22topPSampling%22%0A%20%20type%3A%20%22number%20%7C%20false%22%0A%20%20optional%3A%20true%0A%20%20description%3A%20%22Implements%20nucleus%20sampling%20by%20only%20considering%20tokens%20whose%20cumulative%20probabilities%20reach%20a%20specified%20threshold.%5Cn%5CnFor%20example%2C%20if%20set%20to%200.9%2C%20the%20model%20will%20consider%20only%20the%20most%20likely%20tokens%20that%20together%20add%20up%20to%2090%25%20of%20the%20probability%20mass.%20This%20helps%20balance%20between%20diversity%20and%20quality%20by%20dynamically%20adjusting%20the%20number%20of%20tokens%20considered%20based%20on%20their%20probability%20distribution.%5Cn%5CnValue%20should%20be%20between%200%20and%201.%20Set%20to%20false%20to%20disable%20nucleus%20sampling.%22%0A%0A-%20name%3A%20%22xtcProbability%22%0A%20%20type%3A%20%22number%20%7C%20false%22%0A%20%20optional%3A%20true%0A%20%20description%3A%20%22Controls%20how%20often%20the%20XTC%20(Exclude%20Top%20Choices)%20sampling%20technique%20is%20applied%20during%20generation.%5Cn%5CnXTC%20sampling%20can%20boost%20creativity%20and%20reduce%20clich%C3%A9s%20by%20occasionally%20filtering%20out%20common%20tokens.%20For%20example%2C%20if%20set%20to%200.3%2C%20there's%20a%2030%25%20chance%20that%20XTC%20sampling%20will%20be%20applied%20when%20generating%20each%20token.%5Cn%5CnValue%20should%20be%20between%200%20and%201.%20Set%20to%20false%20to%20disable%20XTC%20completely.%22%0A%0A-%20name%3A%20%22xtcThreshold%22%0A%20%20type%3A%20%22number%20%7C%20false%22%0A%20%20optional%3A%20true%0A%20%20description%3A%20%22Defines%20the%20lower%20probability%20threshold%20for%20the%20XTC%20(Exclude%20Top%20Choices)%20sampling%20technique.%5Cn%5CnWhen%20XTC%20sampling%20is%20activated%20(based%20on%20xtcProbability)%2C%20the%20algorithm%20identifies%20tokens%20with%20probabilities%20between%20this%20threshold%20and%200.5%2C%20then%20removes%20all%20such%20tokens%20except%20the%20least%20probable%20one.%20This%20helps%20introduce%20more%20diverse%20and%20unexpected%20tokens%20into%20the%20generation.%5Cn%5CnOnly%20takes%20effect%20when%20xtcProbability%20is%20enabled.%22%0A%0A-%20name%3A%20%22cpuThreads%22%0A%20%20type%3A%20%22number%22%0A%20%20optional%3A%20true%0A%20%20description%3A%20%22Specifies%20the%20number%20of%20CPU%20threads%20to%20allocate%20for%20model%20inference.%5Cn%5CnHigher%20values%20can%20improve%20performance%20on%20multi-core%20systems%20but%20may%20compete%20with%20other%20processes.%20For%20example%2C%20on%20an%208-core%20system%2C%20a%20value%20of%204-6%20might%20provide%20good%20performance%20while%20leaving%20resources%20for%20other%20tasks.%5Cn%5CnIf%20not%20specified%2C%20the%20system%20will%20use%20a%20default%20value%20based%20on%20available%20hardware.%22%0A%0A-%20name%3A%20%22draftModel%22%0A%20%20type%3A%20%22string%22%0A%20%20optional%3A%20true%0A%20%20description%3A%20%22The%20draft%20model%20to%20use%20for%20speculative%20decoding.%20Speculative%20decoding%20is%20a%20technique%20that%20can%20drastically%20increase%20the%20generation%20speed%20(up%20to%203x%20for%20larger%20models)%20by%20paring%20a%20main%20model%20with%20a%20smaller%20draft%20model.%5Cn%5CnSee%20here%20for%20more%20information%3A%20https%3A%2F%2Flmstudio.ai%2Fdocs%2Fadvanced%2Fspeculative-decoding%5Cn%5CnYou%20do%20not%20need%20to%20load%20the%20draft%20model%20yourself.%20Simply%20specifying%20its%20model%20key%20here%20is%20enough.%22" />)
...
Use the `getContextLength()` Function on the Model Object [#use-the-getcontextlength-function-on-the-model-object]
...
<CodeBlockTabs defaultValue="LLM">
  <CodeBlockTabsList>
    <CodeBlockTabsTrigger value="LLM">
      LLM
    </CodeBlockTabsTrigger>

    <CodeBlockTabsTrigger value="Embedding Model">
      Embedding Model
    </CodeBlockTabsTrigger>
  </CodeBlockTabsList>

  <CodeBlockTab value="LLM">
    ```typescript
  ...
  <CodeBlockTab value="Embedding Model">
    ```typescript
    import { LMStudioClient } from "@lmstudio/sdk";
...
<DocsParamsTable data="-%20name%3A%20Server%20Port%0A%20%20type%3A%20Integer%0A%20%20optional%3A%20false%0A%20%20description%3A%20Port%20number%20on%20which%20the%20LM%20Studio%20API%20server%20listens%20for%20incoming%20connections.%0A%20%20unstyledName%3A%20true%0A-%20name%3A%20Require%20Authentication%0A%20%20type%3A%20Switch%0A%20%20description%3A%20Require%20API%20clients%20to%20provide%20a%20valid%20API%20token%20via%20the%20%60Authorization%60%20header.%20Learn%20more%20in%20the%20%5BAuthentication%5D(%2Fdocs%2Fdeveloper%2Fcore%2Fauthentication)%20section.%0A%20%20unstyledName%3A%20true%0A-%20name%3A%20Serve%20on%20Local%20Network%0A%20%20type%3A%20Switch%0A%20%20description%3A%20Allow%20other%20devices%20on%20the%20same%20local%20network%20to%20access%20the%20API%20server.%20Learn%20more%20in%20the%20%5BServe%20on%20Local%20Network%5D(%2Fdocs%2Fdeveloper%2Fcore%2Fserver%2Fserve-on-network)%20section.%0A%20%20unstyledName%3A%20true%0A-%20name%3A%20Allow%20per-request%20MCPs%0A%20%20type%3A%20Switch%0A%20%20description%3A%20Allow%20API%20clients%20to%20use%20MCP%20(Model%20Context%20Protocol)%20servers%20that%20are%20not%20in%20your%20mcp.json.%20These%20MCP%20connections%20are%20ephemeral%2C%20only%20existing%20as%20long%20as%20the%20request.%20At%20the%20moment%2C%20only%20remote%20MCPs%20are%20supported.%0A%20%20unstyledName%3A%20true%0A-%20name%3A%20Allow%20calling%20servers%20from%20mcp.json%0A%20%20type%3A%20Switch%0A%20%20description%3A%20Allow%20API%20clients%20to%20use%20servers%20you%20defined%20in%20your%20mcp.json%20in%20LM%20Studio.%20This%20can%20be%20a%20security%20risk%20if%20you've%20defined%20MCP%20servers%20that%20have%20access%20to%20your%20file%20system%20or%20private%20data.%20This%20option%20requires%20%22Require%20Authentication%22%20to%20be%20enabled.%0A%20%20unstyledName%3A%20true%0A-%20name%3A%20Enable%20CORS%0A%20%20type%3A%20Switch%0A%20%20description%3A%20Enable%20Cross-Origin%20Resource%20Sharing%20(CORS)%20to%20allow%20applications%20from%20different%20origins%20to%20access%20the%20API.%0A%20%20unstyledName%3A%20true%0A-%20name%3A%20Just%20in%20Time%20Model%20Loading%0A%20%20type%3A%20Switch%0A%20%20description%3A%20Load%20models%20dynamically%20at%20request%20time%20to%20save%20memory.%0A%20%20unstyledName%3A%20true%0A-%20name%3A%20Auto%20Unload%20Unused%20JIT%20Models%0A%20%20type%3A%20Switch%0A%20%20description%3A%20Automatically%20unload%20JIT-loaded%20models%20from%20memory%20when%20they%20are%20no%20longer%20in%20use.%0A%20%20unstyledName%3A%20true%0A-%20name%3A%20Only%20Keep%20Last%20JIT%20Loaded%20Model%0A%20%20type%3A%20Switch%0A%20%20description%3A%20Keep%20only%20the%20most%20recently%20used%20JIT-loaded%20model%20in%20memory%20to%20minimize%20RAM%20usag%0A%20%20unstyledName%3A%20true" />
)
...
Example: Inject Current Time [#example-inject-current-time]
...
Example: Replace Trigger Words [#example-replace-trigger-words]
...
Handling Aborts [#handling-aborts]
...
Examples [#examples](https://127.0.0.1/8000/https://127.0.0.1/3000/https://127.0.0.1/0000)
